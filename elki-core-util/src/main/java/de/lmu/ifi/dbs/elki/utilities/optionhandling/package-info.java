 ...
 * <p>
 * Example code:
 * <blockquote>{@code // Defining Parameters
 ...
 * <p>
 * Example code:
 * <blockquote>{@code  // Getting parameters
 ...
 * <blockquote>{@code // Compound parameter dependency
 ...
 * <blockquote>{@code  // Proper dealing with errors
 * try {
 ...
 * <blockquote>{@code  // Use command line parameters
 ...
 * <blockquote>{@code  // Internal parameterization
 ...
 * <blockquote>{@code  // predefine some parameters
 ...
 * <blockquote>{@code  // config is an existing parameterization
 ...
 * {@link de.lmu.ifi.dbs.elki.utilities.documentation.Reference} (where possible).
 */
/*
