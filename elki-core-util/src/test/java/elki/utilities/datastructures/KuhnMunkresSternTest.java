...
public class KuhnMunkresSternTest {
  @Test
  public void test1() {
    int[] assignment = new KuhnMunkresStern().run(KuhnMunkresTest.TEST1);
    double sum = 0.;
  ...
  @Test
  public void test2() {
    int[] assignment = new KuhnMunkresStern().run(KuhnMunkresTest.TEST2);
    double sum = 0.;
    for(int i = 0; i < assignment.length; i++) {
      assertTrue("Unassigned row " + i, assignment[i] >= 0);
  ...
  public void testNonSq() {
    int[] assignment = new KuhnMunkresStern().run(KuhnMunkresTest.NONSQUARE);
    double sum = 0.;
    for(int i = 0; i < assignment.length; i++) {
      assertTrue("Unassigned row " + i, assignment[i] >= 0);
  ...
  public void testDifficult() {
    int[] assignment = new KuhnMunkresStern().run(KuhnMunkresTest.DIFFICULT);
    double sum = 0.;
    for(int i = 0; i < assignment.length; i++) {
      assertTrue("Unassigned row " + i, assignment[i] >= 0);
  ...
  public void testDifficult2() {
    int[] assignment = new KuhnMunkresStern().run(KuhnMunkresTest.DIFFICULT2);
    double sum = 0.;
    for(int i = 0; i < assignment.length; i++) {
      assertTrue("Unassigned row " + i, assignment[i] >= 0);
  ...
  public void testLarge() {
    ...
    int[] assignment = new KuhnMunkresStern().run(mat);
    double sum = 0.;
    for(int i = 0; i < assignment.length; i++) {
      assertTrue("Unassigned row " + i, assignment[i] >= 0);
