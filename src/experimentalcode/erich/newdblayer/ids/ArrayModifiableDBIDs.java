...
public class ArrayModifiableDBIDs extends ArrayList<DBID> implements ModifiableDBIDs, ArrayDBIDs {
  /**
   * Serial version
   */
   ...
   */
  public ArrayModifiableDBIDs(int initialCapacity) {
   ...
   */
  public ArrayModifiableDBIDs(DBIDs c) {
