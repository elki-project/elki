...
public class RStarTreeChooseSubtreeApproximatively extends RStarTreeChooseSubtree {
  /**
   ...
   * Constructor.
   */
  public RStarTreeChooseSubtreeApproximatively(int candidates) {
    super();
   ...
   */
  protected <I, E, A> int chooseLeastOverlapApproximately(A options, ArrayAdapter<E, A> getter, SpatialAdapter<E> a1, I obj, SpatialAdapter<I> a2) {
  ...
  public static class Parameterizer extends AbstractParameterizer {
    ...
    @Override
    protected RStarTreeChooseSubtreeApproximatively makeInstance() {
      return new RStarTreeChooseSubtreeApproximatively(numCandidates);
    }
  }
}