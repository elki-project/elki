...
import de.lmu.ifi.dbs.elki.visualization.visualizers.visunproj.AbstractUnprojectedVisualizer;
 ...
 */
public class ClusterEvaluationVisualizer extends AbstractUnprojectedVisualizer<DatabaseObject> {
  /**
   ...
   */
  private final EvaluatePairCountingFMeasure.ScoreResult sr;
