...
public class HiCO<O extends DatabaseObject> extends DistanceBasedAlgorithm<O, PreferenceVectorBasedCorrelationDistance, ClusterOrderResult<PreferenceVectorBasedCorrelationDistance>> {
  ...
  protected HiCO(Parameterization config) {
    super(config);
  ...
  @Override
  protected ClusterOrderResult<PreferenceVectorBasedCorrelationDistance> runInTime(Database<O> database) throws IllegalStateException {
    // OPTICS
    ...
    OPTICS<O, PreferenceVectorBasedCorrelationDistance> optics = new OPTICS<O, PreferenceVectorBasedCorrelationDistance>(opticsParameters);
