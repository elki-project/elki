 ...
 */
public abstract class AbstractFixedAmountPartitioner implements IPartitioning {
  ...
  public AbstractFixedAmountPartitioner(Parameterization config) {
    LoggingConfiguration.setLevelFor(AbstractFixedAmountPartitioner.class.getCanonicalName(), Level.ALL.getName());
