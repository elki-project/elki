...
import experimentalcode.frankenb.model.datastorage.HandlerFreeDiskBackedDataStorage;
 ...
 */
public class PackageDescriptorOLD {

  @SuppressWarnings("unused")
  private static final Logging LOG = Logging.getLogger(PackageDescriptorOLD.class);
  ...
  public PackageDescriptorOLD(int id) {
    this.id = id;
  }
    ...
    try {
      ...
      for (Entry<IPartition, Integer> entry : partitions.entrySet()) {
        ...
        if (!partitionFile.exists()) {
          partition.copyTo(partitionFile);
        }
  ...
  public static PackageDescriptorOLD loadFromFile(File file) throws IOException {
    try {
      ...
      PackageDescriptorOLD packageDescriptor = new PackageDescriptorOLD(Integer.valueOf(getRequiredSubElement(rootElement, "id").getTextContent()));
  ...
  private static Map<Integer, IPartition> readPartitionFiles(File parentDirectory, PackageDescriptorOLD packageDescriptor, Element partitionsElement) throws IOException {
  ...
  private static void readPartitionPairings(File parentDirectory, PackageDescriptorOLD packageDescriptor, Map<Integer, IPartition> partitions, Element partitionsElement) throws IOException {
