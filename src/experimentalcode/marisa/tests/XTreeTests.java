...
//     int stop = 10000;
  ...
  public static void main(String[] args) throws NumberFormatException, ParameterException, IOException {
    ...
    // delete a data entry causing both a data node underflow and a directory node underflow
    DoubleVector v = new DoubleVector(new double[] { 0.09674009112079396, 0.8072466030718443, 0.2530943477333132, 0.4385654105281851, 0.27254527319575905, 0.71617898201738, 0.48354443846788775, 0.23561237168947458, 0.909934154931721, 0.8349833720008567, 0.02824066241589951, 0.48225228889160154, 0.911642336389473, 0.3709312818862476, 0.38712729482936314 });
    v.setID(502);
