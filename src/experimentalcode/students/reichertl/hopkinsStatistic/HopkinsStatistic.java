...
/**
 * The Hopkins Statistic measures the probability that a dataset is generated by a uniform data distribution.
 * Data Mining Concepts and Techniques S. 484-485
 * 
...
public class HopkinsStatistic<V extends NumberVector<V, ?>, D extends NumberDistance<D,?>> extends AbstractPrimitiveDistanceBasedAlgorithm<V, D, Result> {
  ...
  public HopkinsResult run(Database database, Relation<V> relation) {
    ...
    //wenn seed nicht initialisiert??? geht das so??? oder bei DBIDUtil noch methode ohne seed
