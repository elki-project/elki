...
public class Voronoi {
  ...
  public static Vector getCircumcircleCenter(Vector a, Vector b, Vector c){
    ...
    u = (b.get(1) - c.get(1)) * (a.get(0) * a.get(0) + a.get(1) * a.get(1)) + 
        (c.get(1) - a.get(1)) * (b.get(0) * b.get(0) + b.get(1) * b.get(1)) +
        (a.get(1) - b.get(1)) * (c.get(0) * c.get(0) + c.get(1) * c.get(1));
    
    v = (c.get(0) - b.get(0)) * (a.get(0) * a.get(0) + a.get(1) * a.get(1)) +
        (a.get(0) - c.get(0)) * (b.get(0) * b.get(0) + b.get(1) * b.get(1)) +
        (b.get(0) - a.get(0)) * (c.get(0) * c.get(0) + c.get(1) * c.get(1));
    
    d = a.get(0) * b.get(1) + b.get(0) * c.get(1) + c.get(0) * a.get(1) - 
        a.get(0) * c.get(1) - b.get(0) * a.get(1) - c.get(0) * b.get(1);
