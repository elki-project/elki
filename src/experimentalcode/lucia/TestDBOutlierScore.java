 ...
 * 
 */
public class TestDBOutlierScore extends OutlierTest implements JUnit4Test{
  ...
  static int interesstingPoint_id141 = 141;
    ...
    int intId;
      ...
      if(intId == interesstingPoint_id141){
        ...
        Assert.assertEquals("Outlier Score of Point with id " + intId + " not right.", 0.6888, outlierScore_p141, 0.0001);
