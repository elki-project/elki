...
public class CompositeEigenPairFilter extends AbstractParameterizable implements EigenPairFilter {
     ...
     * and instantiates {@link #filters} according to the value of parameter
     * {@link #FILTERS_PARAM}.
     * The remaining parameters are passed to each instance of {@link #filters}.
     */
    @Override
