...
public class AlgorithmTest extends AbstractParameterizable {
    ...
    /**
     * Optional parameter to specify the algorithms to be run with default parametrization,
     * must extend {@link Algorithm}. If this parameter is not set all algorithms
    ...
    public static final OptionID INPUT_ID = OptionID.getOrCreateOptionID(
        ...
        "The name of the input file to be parsed. " +
            "This file is used for all specified algorithms as input file."
    );

    /**
     * Parameter that specifies the name of the input file to be parsed.
     * This file is used for all specified algorithms as input file.
     * <p>Key: {@code -test.in} </p>
     */
    ...
    /**
     * Parameter to specify the directory to write the results of the specified algorithms in.
     * The result of each algorithm is written into a file/directory with the name of
     * the class of the according algorithm.
     * <p>Key: {@code -test.out} </p>
     */
    ...
    /**
     * Provides a class that runs all specified algorithms with default parametrization,
     * adding parameters
     * {@link #ALGORITHMS_PARAM}, {@link #INPUT_PARAM}, and {@link #OUTPUT_PARAM}
