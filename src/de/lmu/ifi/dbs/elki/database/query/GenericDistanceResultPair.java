...
public class GenericDistanceResultPair<D extends Distance<D>> extends Pair<D, DBID> implements DistanceResultPair<D> {
   ...
   */
  public GenericDistanceResultPair(D first, DBIDRef second) {
    super(first, DBIDUtil.deref(second));
  }
   ...
   */
  @Override
  public final DBID deref() {
    return second;
  }
  
  @Override
  public int getIntegerID() {
    return DBIDUtil.asInteger(second);
  }
  ...
  public int compareTo(DistanceResultPair<D> o) {
    ...
    return DBIDUtil.compare(second, o);
  }
