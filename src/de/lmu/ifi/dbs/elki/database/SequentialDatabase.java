...
public class SequentialDatabase<O extends DatabaseObject> extends AbstractDatabase<O> {
  ...
  /**
   * @see de.lmu.ifi.dbs.elki.database.Database#kNNQueryForID(java.lang.Integer,
  ...
  /**
   * @see de.lmu.ifi.dbs.elki.database.Database#rangeQuery(java.lang.Integer,
  ...
  /**
   * @see Database#reverseKNNQuery(Integer, int, de.lmu.ifi.dbs.elki.distance.distancefunction.DistanceFunction)
   */
   ...
   *
   * @see Database#parameterDescription()
   */
  @Override
