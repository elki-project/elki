 ...
 * @author Elke Achtert
 * 
 * @apiviz.uses KNNQueryBasedLocalPCAPreprocessor
...
public class HiCO<V extends NumberVector<V, ?>> extends AbstractAlgorithm<V, ClusterOrderResult<PCACorrelationDistance>> {
  ...
  protected ClusterOrderResult<PCACorrelationDistance> runInTime(Database<V> database) throws IllegalStateException {
    ...
    // preprocessor
    opticsParameters.addParameter(IndexBasedDistanceFunction.INDEX_ID, KNNQueryFilteredPCAIndex.Factory.class.getName());
    opticsParameters.addParameter(KNNQueryFilteredPCAIndex.Factory.K_ID, K_PARAM.getValue());
