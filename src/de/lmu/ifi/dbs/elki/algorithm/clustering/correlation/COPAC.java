 ...
 */
public class COPAC<V extends FeatureVector<V, ? extends Number>> extends AbstractAlgorithm<V, Clustering<Model>> implements ClusteringAlgorithm<Clustering<Model>,V> {
