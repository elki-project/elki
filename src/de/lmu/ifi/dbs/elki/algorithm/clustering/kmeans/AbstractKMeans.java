 ...
 */
public abstract class AbstractKMeans<V extends NumberVector<?>, D extends Distance<D>> extends AbstractPrimitiveDistanceBasedAlgorithm<NumberVector<?>, D, Clustering<MeanModel<V>>> implements KMeans {
  /**
