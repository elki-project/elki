...
public class PROCLUS<V extends NumberVector<V, ?>> extends ProjectedClustering<V> {
  ...
  /**
   * Returns the Manhattan segmental distance between o1 and o2 realtive to the
   * specified dimensions.
   * 
   * @param o1 the first object
   * @param o2 the second object
   * @param dimensions the dimensions to be considered
   * @return the Manhattan segmental distance between o1 and o2 realtive to the
   *         specified dimensions
   */
