 ...
 * @param <V> Vector type
 */
public class RankingQualityHistogram<V extends RealVector<V, ?>, D extends NumberDistance<D,?>> extends DistanceBasedAlgorithm<V, D, CollectionResult<DoubleVector>> {
