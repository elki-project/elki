...
public class NNTable {
  ...
  /**
   * Number of nearest neighbors of an object to be considered for computing its
   * LOF.
   */
  private int minpts;
   ...
   * @param minpts number of nearest neighbors of an object to be considered for
   *        computing its LOF
   * @throws java.io.IOException if an I/O-Exception occurs during reading the
   *         file
   */
  public NNTable(File file, int pageSize, int cacheSize, int minpts) throws IOException {
  ...
  /**
   * Returns the neighbors of the object with the specified id for update (i.e.
   * marks the node containing the neighbors as dirty).
   * 
   * @param id the object id
   * @return the neighbors of the object with the specified id
   */
  ...
  /**
   * Inserts the specified new neighbor into the nnTable, old neighbors will be
   * moved, the last (old) neighbor will be removed and returned. The rnnTable
  ...
  /**
   * Computes the reachability distances of the neighbors of the object with the
   * specified id and inserts them into the nnTable.
   * 
   * @param id the object id
   */
   ...
   * 
   * @param neighbor the neighbor of which the reachability distance is to be
   *        set
  ...
  protected static class NeighborPrinter implements ObjectPrinter<BTreeData<DefaultKey, NeighborList>> {
