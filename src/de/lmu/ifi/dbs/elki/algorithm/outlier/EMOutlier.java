...
public class EMOutlier<V extends NumberVector<V, ?>> extends AbstractAlgorithm<V, OutlierResult>{
  ...
  public Description getDescription() {
    return new Description("EM Outlier", "Outlier Detection based on the generic EM clustering", "The outlier score assigned is based on the highest cluster probability obtained from EM clustering.");
  }
