...
public class HSBHistogramQuadraticDistanceFunction<V extends NumberVector<V, ?>> extends WeightedDistanceFunction<V> {
   ...
   */
  IntListParameter BPP_PARAM = new IntListParameter(BPP_ID, bppConstraints);
   ...
   */
  public HSBHistogramQuadraticDistanceFunction() {
    super(null);
    addOption(BPP_PARAM);
  }
  ...
  public List<String> setParameters(List<String> args) throws ParameterException {
    ...
    if(quant.size() != 3) {
      throw new WrongParameterValueException(BPP_PARAM, "I need exactly three values for the bpp parameter.");
    }
