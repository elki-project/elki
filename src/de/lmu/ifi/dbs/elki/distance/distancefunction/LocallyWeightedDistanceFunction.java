...
public class LocallyWeightedDistanceFunction<O extends RealVector<O,?>,P extends Preprocessor<O>> extends AbstractLocallyWeightedDistanceFunction<O,P> implements SpatialDistanceFunction<O, DoubleDistance> {
   ...
   *         distance function
   * @see de.lmu.ifi.dbs.elki.index.tree.spatial.SpatialDistanceFunction#distance(HyperBoundingBox, de.lmu.ifi.dbs.elki.utilities.HyperBoundingBox)
   */
   ...
   *         according to this distance function
   * @see de.lmu.ifi.dbs.elki.index.tree.spatial.SpatialDistanceFunction#centerDistance(HyperBoundingBox, de.lmu.ifi.dbs.elki.utilities.HyperBoundingBox)
   */
