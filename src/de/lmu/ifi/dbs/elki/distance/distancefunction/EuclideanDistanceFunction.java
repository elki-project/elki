 ...
 */
public class EuclideanDistanceFunction<V extends FeatureVector<V, ? extends Number>> extends AbstractDoubleDistanceFunction<V> implements SpatialDistanceFunction<V, DoubleDistance> {
  /**
