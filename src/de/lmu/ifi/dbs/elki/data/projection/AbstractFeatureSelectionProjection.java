 ...
 */
public abstract class AbstractFeatureSelectionProjection<V extends FeatureVector<V, F>, F> implements Projection<V, V> {
  /**
   * Array adapter
   */
   ...
   */
  public AbstractFeatureSelectionProjection(SubsetArrayAdapter<F, V> adapter) {
    super();
