...
class MkMaxDirectoryEntry<D extends Distance<D>> extends MTreeDirectoryEntry<D> implements MkMaxEntry<D> {
  ...
  /**
   * @see de.lmu.ifi.dbs.elki.index.tree.metrical.mtreevariants.mkmax.MkMaxEntry#getKnnDistance()
   */
  ...
  /**
   * @see de.lmu.ifi.dbs.elki.index.tree.metrical.mtreevariants.mkmax.MkMaxEntry#setKnnDistance(de.lmu.ifi.dbs.elki.distance.Distance)
   */
