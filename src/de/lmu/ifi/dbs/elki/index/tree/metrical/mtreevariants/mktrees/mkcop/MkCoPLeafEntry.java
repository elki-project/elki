 ...
 * @author Elke Achtert
 */
class MkCoPLeafEntry<D extends NumberDistance<D, N>, N extends Number> extends MTreeLeafEntry<D> implements MkCoPEntry<D, N> {
   ...
   */
  public <O extends DatabaseObject> D approximateProgressiveKnnDistance(int k, DistanceQuery<O, D> distanceFunction) {
