...
/**
 * Basic in-memory heap structure for double keys and V values,
 ...
 * @param <V> Value type
 */
public class DoubleObjectMinHeap<V> extends AbstractHeap implements DoubleObjectHeap<V> {
  /**
   * Heap storage: keys
   */
  private double[] keys;
   ...
   * @apiviz.exclude
   */
  protected class UnsortedIter extends AbstractHeap.UnsortedIter implements DoubleObjectHeap.UnsortedIter<V> {
    @Override
