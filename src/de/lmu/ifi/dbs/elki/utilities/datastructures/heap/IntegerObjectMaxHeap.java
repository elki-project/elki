...
/**
 * Basic in-memory heap structure for int keys and Object values,
 ...
 * @param <V> Value type
 */
public class IntegerObjectMaxHeap<V> extends AbstractHeap implements IntegerObjectHeap<V> {
  /**
   * Heap storage: keys
   */
  private int[] keys;
   ...
   */
  public IntegerObjectMaxHeap(int size) {
    super();
    this.size = 0;
