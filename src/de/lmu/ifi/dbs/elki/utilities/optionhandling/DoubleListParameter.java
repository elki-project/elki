...
public class DoubleListParameter extends ListParameter<Double> {
  ...
  public boolean isValid(String value) throws ParameterException {
    ...
    if(values.length == 0) {
      ...
      throw new WrongParameterValueException("Wrong parameter format! Given list of double values for parameter \"" + getName() + "\" is either empty or has the wrong format!\nParameter value required:\n" + getDescription());
    }
