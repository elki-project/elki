...
public class IntParameter extends NumberParameter<Integer> {
  ...
  // DoubleParameter takes (optionID, default), IntParameter takes (optionID,
  // null, default)
  ...
  public boolean isValid(String value) throws ParameterException {
    try {
      ...
      throw new WrongParameterValueException("Wrong parameter format. Parameter \"" + getName() + "\" requires an integer value. (given value: " + value + ")\n");
    }
