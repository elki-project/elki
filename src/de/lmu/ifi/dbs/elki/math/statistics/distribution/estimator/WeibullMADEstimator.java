...
public class WeibullMADEstimator implements DistributionEstimator<WeibullDistribution> {
  /**
   * The more robust median based estimator.
   */
  public static final WeibullMADEstimator STATIC = new WeibullMADEstimator();

  /**
   * Constructor. Private: use static instance!
   */
  private WeibullMADEstimator() {
    super();
  }
  ...
  public static class Parameterizer extends AbstractParameterizer {
    @Override
    protected WeibullMADEstimator makeInstance() {
      return STATIC;
    }
  }
}
