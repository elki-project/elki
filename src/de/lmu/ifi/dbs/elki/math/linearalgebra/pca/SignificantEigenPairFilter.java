...
public class SignificantEigenPairFilter extends AbstractLoggable implements EigenPairFilter, Parameterizable {
  ...
  public Description getDescription() {
    return new Description(SignificantEigenPairFilter.class, "Significant EigenPair Filter", "Sorts the eigenpairs in decending order of their eigenvalues and looks for the maxmimum contrast of current Eigenvalue / average of remaining Eigenvalues.");
  }
}