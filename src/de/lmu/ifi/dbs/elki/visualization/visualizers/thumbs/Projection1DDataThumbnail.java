 ...
 */
public class Projection1DDataThumbnail<NV extends NumberVector<NV,?>> extends Projection1DThumbnail<NV> implements DatabaseListener<NV> {
  /**
   * Constructor.
   * 
   ...
   */
  public Projection1DDataThumbnail(Projection1DVisualizer<NV> vis, VisualizerContext<? extends NV> context, SVGPlot svgp, VisualizationProjection proj, double width, double height, int tresolution) {
