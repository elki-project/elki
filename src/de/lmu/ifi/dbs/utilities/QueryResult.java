...
public class QueryResult {
   ...
   * @param distance the distance of the underlying database object to the query object
   */
   ...
   * @return the distance of the underlying database object to the query object
   */
