...
public final class Util {
  ...
  /**
   * Returns the minimum of the given Distances or the first, if none is
   ...
   * <p/>
   * If the Class for className is not found,
   * the instantiation is tried using the package of
   * the given type as package of the given className.
   *
