...
public final class Util {
  ...
  /**
   * Returns the centroid as a RealVector object of the specified objects stored in the
   * given database. The objects belonging to the specified ids must be instance of
