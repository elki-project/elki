...
/**
 * Represents a Less-Than GlobalParameterConstraint. The value of the
 * first NumberParameter has to be less than the value of the second
...
public class LessGlobalConstraint implements GlobalParameterConstraint {
	...
	/**
	 * Creates a Less-Than GlobalParameterConstraint, i.e. the value of
	 * the first NumberParameter given has to be less than the value of
	 * the second NumberParameter given.
	 * 
	 * @param first first NumberParameter
	 * @param second second NumberParameter
	 */
	...
	/**
	 * Checks if the value of the first NumberParameter is less than the
	...
	public void test() throws ParameterException {
		...
		if(first.getNumberValue().doubleValue() >= second.getNumberValue().doubleValue()){
			...
			throw new WrongParameterValueException("Global Parameter Constraint Error: \n"
					...
					+ "\" has to be less than the" + "value of parameter \""
					+ second.getName() + "\"!\n");
		}
