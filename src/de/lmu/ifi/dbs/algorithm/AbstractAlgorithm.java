...
=======
public abstract class AbstractAlgorithm<O extends DatabaseObject> implements
        Algorithm<O>
{
    /**
     * Flag to allow verbose messages.
    ...
    public final void run(Database<O> database) throws IllegalStateException
    {
        ...
        if (database instanceof IndexDatabase && isTime())
        {
            System.out.println(this.getClass().getName() + " I/O-time : "
                    + ((IndexDatabase) database).getIOAccess());
        }
    }
