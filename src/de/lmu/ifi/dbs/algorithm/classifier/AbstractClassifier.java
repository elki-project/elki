...
public abstract class AbstractClassifier<O extends DatabaseObject> extends AbstractAlgorithm<O> implements Classifier<O>
{
     ...
     * 
     * @param database
     *            the database to build the model on
     ...
     * @throws IllegalStateException
     *             if the Classifier has not been initialized or properly
     *             trained
     */
    ...
    /**
     * Sets the given class labels as class labels to use.
     * The given array gets sorted by the setting method.
     * 
     * 
