 ...
 */
public class COPAC extends AbstractAlgorithm<DoubleVector> implements Clustering<DoubleVector>
{
    /**
     ...
     */
    private Clustering<DoubleVector> partitionAlgorithm;
    ...
    protected void runInTime(Database<DoubleVector> database) throws IllegalStateException
    {
        ...
        try
        {
            ...
            Map<Integer, ClusteringResult<DoubleVector>> results = new Hashtable<Integer, ClusteringResult<DoubleVector>>();
     ...
     */
    public ClusteringResult<DoubleVector> getResult()
    {
        return result;
    }
