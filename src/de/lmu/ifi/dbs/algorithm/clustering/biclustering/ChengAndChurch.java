...
public class ChengAndChurch<V extends RealVector<V, Double>> extends
	 ...
	 * 
	 * @param val
	 *            the value who`s score will be calculated
	 * @param i
	 *            the row-key to the corresponding rowMean
	 * @param j
	 *            the column-key to the corresponding columnMean
	...
	/**
	 * @param row
	 *            the row of the requested value
	 * @param col
	 *            the column of the requested value
