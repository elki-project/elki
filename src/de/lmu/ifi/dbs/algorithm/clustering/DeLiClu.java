 ...
 */
public class DeLiClu<O extends NumberVector, D extends Distance<D>> extends DistanceBasedAlgorithm<O, D>
{
    /**
    ...
    protected void runInTime(Database<O> database) throws IllegalStateException
    {
        ...
        try
        {
            ...
            {
                throw new IllegalArgumentException("Database must be an instance of " + DeLiCluTreeDatabase.class.getName());
            }
     ...
     */
    private void expandNodes(DeLiCluTreeDatabase db, SpatialDistanceFunction<O, D> distFunction, SpatialObjectPair nodePair, KNNJoinResult<O, D> knns)
    {
     ...
     * @param knns         the knn list
     */
    private void reinsertExpanded(SpatialDistanceFunction<O, D> distFunction, DeLiCluTreeDatabase<O> db, List<Entry> path, KNNJoinResult<O, D> knns)
    {
    ...
    private void reinsertExpanded(SpatialDistanceFunction<O, D> distFunction, DeLiCluTreeDatabase<O> db, List<Entry> path, int index, Entry parentEntry, KNNJoinResult<O, D> knns)
    {
