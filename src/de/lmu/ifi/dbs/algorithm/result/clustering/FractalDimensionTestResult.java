...
public class FractalDimensionTestResult<V extends RealVector<V,?>> extends AbstractResult<V>
{
    ...
    public void output(File out, Normalization<V> normalization, List<AttributeSettings> settings) throws UnableToComplyException
    {
        ...
        try
        {
            ...
            {
                points.add(new DoublePair(Math.log(distanceFunction.distance(this.id1Supporter.get(i-1), this.id1).getDoubleValue()),Math.log(i)));
            }
            ...
            {
                points.add(new DoublePair(Math.log(distanceFunction.distance(this.id2Supporter.get(i-1), this.id2).getDoubleValue()),Math.log(i)));
            }
            ...
            {
                points.add(new DoublePair(Math.log(distanceFunction.distance(this.centroidSupporter.get(i-1), this.centroid).getDoubleValue()),Math.log(i)));
            }
