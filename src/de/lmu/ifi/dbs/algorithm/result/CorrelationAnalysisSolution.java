...
public class CorrelationAnalysisSolution extends AbstractResult<DoubleVector>
{
     ...
     */
    public CorrelationAnalysisSolution(Matrix solution, Database<DoubleVector> db, int correlationDimensionality, NumberFormat nf)
    {
        super(db);
     ...
     * XXX probably return DoubleDistance instead of double ???
     */
