...
public class CorrelationAnalysisSolution extends AbstractResult<RealVector>
{
     ...
     * 
     * @param solution
     *            the matrix describing the solution equations
     * @param db
     *            the database containing the objects
     * @param strongEigenvectors
     *            the strong eigenvectors of the hyperplane induced by the
     *            correlation
     * @param centroid
    ...
    public CorrelationAnalysisSolution(Matrix solution,
            Database<RealVector> db, Matrix strongEigenvectors, Matrix centroid)
    {
     ...
     */
    public CorrelationAnalysisSolution(Matrix solution,
            Database<RealVector> db, Matrix strongEigenvectors,
            Matrix centroid, NumberFormat nf)
    {
        super(db);

        this.solution = solution;
        this.correlationDimensionality = strongEigenvectors
                .getColumnDimension();
     ...
     * @param normalization
     *            Normalization to restore original values according to, if this
     ...
     */
    public Matrix getPrintSolutionMatrix(Normalization<RealVector> normalization)
            throws NonNumericFeaturesException
    {
