 ...
 */
public class PointerRepresentation<T extends MetricalObject> implements Result
{
    /**
     ...
     *            the database containing the objects
     */
    public PointerRepresentation(HashMap<Integer, Integer> pi, HashMap<Integer, SLINK<T>.SLinkDistance> lambda, DistanceFunction<T> distanceFunction, Database<T> database)
    {
        this.pi = pi;
        this.lambda = lambda;
