...
public class KDDTask extends AbstractParameterizable {
	...
	public String[] setParameters(String[] args) throws ParameterException {
		...
		if (optionHandler.isSet(DESCRIPTION_P)) {
			String parameterizableName = optionHandler
					.getOptionValue(DESCRIPTION_P);
			Parameterizable p;
			try {
				try {
				...
				throw new WrongParameterValueException(DESCRIPTION_P,
						parameterizableName, DESCRIPTION_D, e);
			}
