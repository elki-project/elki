 ...
 */
public class SLINK extends DistanceBasedAlgorithm {
  /**
   ...
   *
   * @param newID the id of the object to be inserted into the pointer representation
   */
  ...
  /**
   * Second step: Determine the pairwise distances from all objects in
   * the pointer representation to the new object with the specified id.
   *
   * @param database the database holding the objects
   * @param newID    the id of the object to be inserted into the pointer representation
   */
  private void step2(Database database, int newID, ArrayList<Integer> processedIDs) {
    // M(i) = dist(i, n+1)
    MetricalObject newObject = database.get(newID);
