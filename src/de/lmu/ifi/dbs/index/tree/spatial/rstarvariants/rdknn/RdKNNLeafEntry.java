...
public class RdKNNLeafEntry<D extends NumberDistance> extends SpatialLeafEntry implements RdKNNEntry<D> {
  ...
  /**
   * @see de.lmu.ifi.dbs.index.tree.spatial.rstarvariants.rdknn.RdKNNEntry#getKnnDistance()
   */
  ...
  /**
   * @see de.lmu.ifi.dbs.index.tree.spatial.rstarvariants.rdknn.RdKNNEntry#setKnnDistance(de.lmu.ifi.dbs.distance.NumberDistance)
   */
