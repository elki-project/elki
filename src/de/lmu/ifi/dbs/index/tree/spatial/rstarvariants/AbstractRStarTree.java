...
public abstract class AbstractRStarTree<O extends NumberVector<O,? extends Number>, N extends AbstractRStarTreeNode<N, E>, E extends SpatialEntry> extends SpatialIndex<O, N, E> {
  ...
  public String toString() {
    ...
    if (file != null) {
      ...
      de.lmu.ifi.dbs.index.tree.BreadthFirstEnumeration<O, N, E> enumeration = new de.lmu.ifi.dbs.index.tree.BreadthFirstEnumeration<O, N, E>(this, getRootPath());
  ...
  /**
   * @see TreeIndex#initializeCapacities(de.lmu.ifi.dbs.data.DatabaseObject,boolean)
   */
