...
class MkMaxTreeNode<O extends DatabaseObject, D extends Distance<D>> extends AbstractMTreeNode<O, D, MkMaxTreeNode<O, D>, MkMaxEntry<D>> {
  ...
  /**
   * @see AbstractMTreeNode#adjustEntry(de.lmu.ifi.dbs.index.tree.metrical.mtreevariants.MTreeEntry,Integer,Distance,de.lmu.ifi.dbs.index.tree.metrical.mtreevariants.AbstractMTree)
   */
