...
class MkCoPTreeNode<O extends DatabaseObject, D extends NumberDistance<D>> extends AbstractMTreeNode<O, D, MkCoPTreeNode<O, D>, MkCoPEntry<D>> {
  ...
  /**
   * @see AbstractMTreeNode#adjustEntry(de.lmu.ifi.dbs.index.tree.metrical.mtreevariants.MTreeEntry, Integer, de.lmu.ifi.dbs.distance.Distance, de.lmu.ifi.dbs.index.tree.metrical.mtreevariants.AbstractMTree)
   */
...
//    entry.setConservativeKnnDistanceApproximation(conservativeKnnDistanceApproximation(k_max));
  ...
  /**
   * @see AbstractMTreeNode#test(de.lmu.ifi.dbs.index.tree.metrical.mtreevariants.MTreeEntry, AbstractMTreeNode, int, de.lmu.ifi.dbs.index.tree.metrical.mtreevariants.AbstractMTree)
   */
