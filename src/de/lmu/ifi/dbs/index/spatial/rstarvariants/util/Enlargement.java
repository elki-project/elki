package de.lmu.ifi.dbs.index.spatial.rstarvariants.util;
...
public class Enlargement<E extends SpatialEntry> implements Comparable<Enlargement<E>> {
   ...
   */
  private IndexPathComponent<E> pathComponent;
   ...
   */
  public Enlargement(IndexPathComponent<E> pathComponent, double volume, double volInc, double overlapInc) {
   ...
   */
  public IndexPathComponent<E> getPathComponent() {
