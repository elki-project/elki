...
public interface SpatialIndex {
   ...
   */
  boolean delete(FeatureVector o);
   ...
   */
  List<QueryResult> rangeQuery(final FeatureVector obj, final String epsilon,
   ...
   * @return a List of the query results
   */
  List<QueryResult> kNNQuery(final FeatureVector obj, final int k,
                             final SpatialDistanceFunction distanceFunction);
