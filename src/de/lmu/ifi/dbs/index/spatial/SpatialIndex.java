...
public abstract class SpatialIndex<O extends NumberVector, N extends SpatialNode<N, E>, E extends SpatialEntry> extends Index<O, N, E> {
	...
	public SpatialIndex() {
		...
		StringParameter bulk = new StringParameter(BULK_LOAD_STRATEGY_P, BULK_LOAD_STRATEGY_D, new EqualStringConstraint(new String[] {
				BulkSplit.Strategy.MAX_EXTENSION.getClass().getName(), BulkSplit.Strategy.ZCURVE.getClass().getName() }));
