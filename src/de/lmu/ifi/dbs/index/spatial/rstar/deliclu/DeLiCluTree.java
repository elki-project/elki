...
public class DeLiCluTree<T extends NumberVector> extends RTree<T>
{
     ...
     * 
     * @param fileName
     *            the name of the file storing the RTree
     * @param cacheSize
     ...
     *            the dimensionality of the data objects to be indexed
     * @param fileName
     ...
     * 
     * @param objects
     *            the vector objects to be indexed
     * @param fileName
     *            the name of the file for storing the entries, if this
     *            parameter is null all entries will be hold in main memory
     * @param pageSize
     *            the size of a page in bytes
     * @param cacheSize
     *            the size of the cache (must be >= 1)
     */
     ...
     *            the size of a page in Bytes
     * @param dimensionality
     *            the dimensionality of the data to be indexed
     */
     ...
     * 
     * @param entry
     *            the current root of the subtree to be tested
     * @param mbr
     *            the mbr to look for
     * @param id
     *            the id to look for
