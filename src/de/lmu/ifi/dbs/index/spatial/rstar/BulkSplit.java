...
class BulkSplit<T extends NumberVector>
{
     ...
     * 
     * @param objects
     *            the data objects to be splitted
     * @param minEntries
     *            the minimum number of entries in a node
     * @param maxEntries
     *            the maximum number of entries in a node
     */
    public BulkSplit(List<T> objects, int minEntries, int maxEntries)
    {
        chooseObjectSplitAxis(objects);
     ...
     *            the data objects to be splitted
     */
    private void chooseObjectSplitAxis(List<T> objects)
    {
     ...
     */
    private int chooseNodeSplitAxis(RTreeNode[] nodes)
    {
     ...
     * 
     * @param numEntries
     *            the number of entries to be split
     * @param minEntries
     *            the number of minimum entries in the node to be split
     * @param maxEntries
