...
/**
 * Encapsulates the header information of a R*-Tree. This information is needed
 * for persistent storage.
 *
 * @author Elke Achtert (<a
 *         href="mailto:achtert@dbs.ifi.lmu.de">achtert@dbs.ifi.lmu.de</a>)
 */
public class RTreeHeader extends DefaultPageHeader {
  /**
   ...
   */
  public RTreeHeader(int pageSize, int dirCapacity, int leafCapacity,
