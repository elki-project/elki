 ...
 * after deletion / insertion operations on the RTree.
 * 
...
class ReinsertEntry implements Comparable<ReinsertEntry>
{
     ...
     * 
     * @param entry
     *            the entry to be reinsert
     * @param dist
     *            the center-distance of this entry's MBR and the MBR of its
     *            (current) parent
     */
    ...
    /**
     * Compares the distance value of this ReinsertEntry with the distance value
     * of the specified ReinsertEntry o. A negative integer is returned if this
     * distance is greater than the other distance, a positive integer is
     * returned if this distance is lower than the other distance. If both
     * values are equal the ids of the two entries are compared.
     * 
     * @param reinsertEntry
     *            the ReinsertEntry to be compared
