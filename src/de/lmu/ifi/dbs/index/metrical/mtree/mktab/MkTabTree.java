 ...
 */
public class MkTabTree<O extends DatabaseObject, D extends Distance<D>> extends
        MTree<O, D>
{
    /**
     * The parameter kmax.
    ...
    protected void initCapacity(int pageSize)
    {
        ...
        dirCapacity = (int) (pageSize - overhead)
                / (4 + 4 + distanceSize + distanceSize + 4 + kmax
                        * distanceSize) + 1;
        ...
        leafCapacity = (int) (pageSize - overhead)
                / (4 + distanceSize + 4 + kmax * distanceSize) + 1;
    ...
    private TreePath split(TreePath path)
    {
        ...
        parent.addDirectoryEntry(new MkTabDirectoryEntry<D>(assignments
        ...
        // for node in parent
        MkTabDirectoryEntry<D> entry1 = (MkTabDirectoryEntry<D>) parent
                .getEntry(nodeIndex);
    ...
    {
        KNNList<D> knns = new KNNList<D>(kmax, distanceFunction
                .infiniteDistance());
    ...
    private void insert(List<O> objects)
    {
        ...
        for (O object : objects)
        {
            ...
            knnLists.put(object.getID(), new KNNList<D>(kmax, distanceFunction
                    .infiniteDistance()));
