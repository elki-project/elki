 ...
 */
public class Assignments<D extends Distance<D>>
{
    /**
     ...
     */
    private List<MTreeEntry<D>> firstAssignments;

    /**
     * The assignments to the second routing object.
     */
    private List<MTreeEntry<D>> secondAssignments;
     ...
     *            the second covering radius
     * @param firstAssignments
     *            the assignments to the first routing object
     * @param secondAssignments
     *            the assignments to the second routing object
     */
    public Assignments(Integer id1, Integer id2, D firstCoveringRadius,
            D secondCoveringRadius, Set<MTreeEntry<D>> firstAssignments,
            Set<MTreeEntry<D>> secondAssignments)
    {
        ...
        this.firstAssignments = new ArrayList<MTreeEntry<D>>(firstAssignments);
        this.secondAssignments = new ArrayList<MTreeEntry<D>>(secondAssignments);
    }
     ...
     */
    public List<MTreeEntry<D>> getFirstAssignments()
    {
     ...
     */
    public List<MTreeEntry<D>> getSecondAssignments()
    {
