 ...
 */
public class MTreeNode<O extends DatabaseObject, D extends Distance<D>> implements Node {
   ...
   */
  public MTreeNode(PageFile<MTreeNode<O, D>> file, int capacity,
                   boolean isLeaf) {
    initLogger();
    this.file = file;
    this.nodeID = null;
   ...
   */
  public MTreeNode<O, D> splitEntries(List<MTreeEntry<D>> assignmentsToFirst,
                                      List<MTreeEntry<D>> assignmentsToSecond) {
    if (isLeaf) {
