...
/**
 * The class LeafEntry represents an entry in a leaf node of an M-Tree. A
 * LeafEntry consists of an id (representing the unique id of the underlying
 * object in the database) and the distance from the object to its parent
...
public class MTreeLeafEntry<D extends Distance> implements MTreeEntry<D>
{
    ...
    /**
     * Writes the id and the parent distance of this entry to the specified
     * output stream.
     * 
     * @param out
    ...
    /**
     * Reads the id and the parent distance of this entry from the specified
     * input stream.
     * 
     * @param in
