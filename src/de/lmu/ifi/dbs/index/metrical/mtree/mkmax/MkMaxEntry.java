...
/**
 * Defines the requirements for an entry in a MkNN-Tree node. Additionally to an
 * entry in a M-Tree getter and setter methods for the knn distance are
 * provided.
 * 
