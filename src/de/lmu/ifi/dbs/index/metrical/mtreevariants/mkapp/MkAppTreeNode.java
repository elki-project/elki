...
//    entry.setKnnDistanceApproximation(knnDistanceApproximation());
  ...
  /**
   * @see de.lmu.ifi.dbs.index.metrical.mtreevariants.AbstractMTreeNode#test(de.lmu.ifi.dbs.index.metrical.mtreevariants.MTreeEntry, de.lmu.ifi.dbs.index.metrical.mtreevariants.AbstractMTreeNode, int, de.lmu.ifi.dbs.index.metrical.mtreevariants.AbstractMTree)
   */
