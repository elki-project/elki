 ...
 */
public class MLBDistSplit<O extends DatabaseObject, D extends Distance<D>, N extends MTreeNode<O, D, N, E>, E extends MTreeEntry<D>> extends MTreeSplit<O, D, N, E> {
  ...
  private void promote(N node, DistanceFunction<O, D> distanceFunction) {
    ...
    for (int i = 0; i < node.getNumEntries(); i++) {
      ...
      list1.add(new DistanceEntry<D, E>((E) node.getEntry(i), d1, i));
      list2.add(new DistanceEntry<D, E>((E) node.getEntry(i), d2, i));
    }
