...
public abstract class AbstractMTree<O extends DatabaseObject, D extends Distance<D>, N extends AbstractMTreeNode<O, D, N, E>, E extends MTreeEntry<D>>
	...
	public AbstractMTree() {
		super();
		ClassParameter distFunction = new ClassParameter(AbstractMTree.DISTANCE_FUNCTION_P, AbstractMTree.DISTANCE_FUNCTION_D,
	 ...
	 * 
	 * @param object
	 *            the object to be inserted todo: in subclasses
	 */
	 ...
	 * 
	 * @param subtree
	 *            the subtree to be tested for insertion
	 * @param objectID
	...
	protected IndexPath<E> choosePath(Integer objectID, IndexPath<E> subtree) {
		...
		return choosePath(objectID, subtree
				.pathByAddingChild(new IndexPathComponent<E>(bestCandidate.getEntry(), bestCandidate.getIndex())));
	}
	 ...
	 * 
	 * @param oldRoot
	 *            the old root of this RTree
	 * @param newNode
	 *            the new split node
	 * @return the path to the new root node that points to the two specified
	 *         child nodes
	 */
	private IndexPath<E> createNewRoot(final N oldRoot, final N newNode, Integer firstRoutingObjectID, Integer secondRoutingObjectID) {
