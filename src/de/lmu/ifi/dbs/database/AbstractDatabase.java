...
public abstract class AbstractDatabase implements Database {
  ...
  *      java.lang.Integer)
  ...
  /**
   * Provides a new id for the specified metrical object
   * suitable as key for a new insertion and sets this id
   * in the specified metrical object.
   *
   * @return a new id suitable as key for a new insertion
   * @throws UnableToComplyException if the database has reached the limit
   * and, therefore, new insertions are not possible
   */
