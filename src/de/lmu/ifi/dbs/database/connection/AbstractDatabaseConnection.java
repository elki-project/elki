        ...
        implements DatabaseConnection<O>
{
     ...
     */
    public static final String DATABASE_CLASS_D = "<class>a class name specifying the database to be provided by the parse method (must implement "
     ...
     */
    public static final String CLASS_LABEL_CLASS_D = "<class>a class name extending "
            + ClassLabel.class.getName()
            + " as association of occuring class labels. Default: association of labels as simple label.";
    ...
    {
        parameterToDescription.put(DATABASE_CLASS_P
                + OptionHandler.EXPECTS_VALUE, DATABASE_CLASS_D);
        parameterToDescription.put(CLASS_LABEL_INDEX_P
                + OptionHandler.EXPECTS_VALUE, CLASS_LABEL_INDEX_D);
        parameterToDescription.put(CLASS_LABEL_CLASS_P
                + OptionHandler.EXPECTS_VALUE, CLASS_LABEL_CLASS_D);
        parameterToDescription.put(EXTERNAL_ID_INDEX_P
                + OptionHandler.EXPECTS_VALUE, EXTERNAL_ID_INDEX_D);
