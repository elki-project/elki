...
public interface Database {
  ...
  /**
   * Initializes the databases by inserting the specified objects into the database.
   *
  ...
  /**
   * Performs a range query for the given object ID with the given
   ...
   * @return Object the Object represented by to the specified id in the Database
   */
   ...
   *
   * @param associationID the id of the association, respectively the name of the relation
   ...
   * @param associationID the id of the association, respectively the name of the relation
   * @param objectID      the id of the Object to which the association is related
   * @return Object the association which is associated with the specified Object
   */
