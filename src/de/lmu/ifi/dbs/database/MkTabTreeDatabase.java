 ...
 */
public class MkTabTreeDatabase<O extends DatabaseObject, D extends Distance<D>>
        extends MkMaxTreeDatabase<O, D>
{
    ...
    {
        return new MkTabTree<O, D>(fileName, pageSize, cacheSize,
    ...
    public String description()
    {
        ...
        description
                .append(" holds all the data in an MkTabTree-Tree index structure.\n");
