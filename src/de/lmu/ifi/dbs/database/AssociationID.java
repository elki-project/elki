...
public class AssociationID extends ConstantObject
{
     ...
     */
    public static final AssociationID LABEL = new AssociationID(
            "associationIDLabel", String.class);

    /**
     * The association id to associate a class to an object.
     */
    public static final AssociationID CLASS = new AssociationID(
            "associationIDClass", ClassLabel.class);

    /**
     * The association id to associate an external id to an object.
     */
    public static final AssociationID EXTERNAL_ID = new AssociationID(
            "associationIDExternalID", String.class);

    /**
     * The association id to associate a correlation pca to an object.
     */
    public static final AssociationID LOCAL_PCA = new AssociationID(
            "associationIDPCA", LocalPCA.class);

    /**
     * The association id to associate the neighbors of an object.
     */
    public static final AssociationID NEIGHBORS = new AssociationID(
            "associationIDNeighbors", List.class);

    /**
     * The association id to associate the LRD of an object for the LOF
     * algorithm.
     */
    public static final AssociationID LRD = new AssociationID(
            "associationIDLRD", Double.class);

    /**
     * The association id to associate the locally weighted matrix of an object
     * for the locally weighted distance function.
     */
    public static final AssociationID LOCALLY_WEIGHTED_MATRIX = new AssociationID(
            "locallyWeightedMatrix", Matrix.class);
