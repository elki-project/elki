 ...
 */
public class DeLiCluTreeDatabase<T extends NumberVector> extends
        SpatialIndexDatabase<T>
{
    ...
    public String description()
    {
        ...
        description
                .append(" holds all the data in a DeliRTree index structure.\n");
     ...
     * 
     * @param id
     *            the id of the object to be marked as handled
