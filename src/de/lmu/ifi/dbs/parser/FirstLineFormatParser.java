 ...
 * Dimensionality and place of labels are fixed after parsing the first line.
 * @author Arthur Zimek (<a href="mailto:zimek@dbs.ifi.lmu.de">zimek@dbs.ifi.lmu.de</a>)
 */
public class FirstLineFormatParser extends StandardLabelParser
{
    /**
     * Provides a parser for parsing one point per line, attributes separated by whitespace.
     * 
    ...
    public Database<DoubleVector> parse(InputStream in)
    {
        ...
        try
        {
            Set<Integer> labelIndices = new HashSet<Integer>();
                    ...
                    for(int i = 0; i < entries.length; i++)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    throw new IllegalArgumentException("Illegal format of line "+lineNumber+".");
                                }
                            }
                        }
                    }
    ...
    public String description()
    {
        ...
        description.append(FirstLineFormatParser.class.getName());
        ...
        description.append("Dimensionality and place of labels are fixed after parsing the first line.\n");
