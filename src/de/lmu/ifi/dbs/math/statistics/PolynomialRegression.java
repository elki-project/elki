...
//    System.out.println("y"+y);
  ...
  public static void main(String[] args) {
    {
      int p = 2;
      double[] x1Array = new double[]{1.0, 1,1,2,2,2,3,3,3,4,4,4};
      ...
      Vector x1 = new Vector(x1Array);
      Vector y1 = new Vector(y1Array);
      MultipleLinearRegression r1 = new PolynomialRegression(y1, x1, p);
      System.out.println("beta1 = " + r1.getEstimatedCoefficients());

      double[] x2Array = new double[]{1,2,3,4};
      double[] y2Array = new double[]{8.0 / 3, 3, 14.0 / 3, 16.0 / 3.0};
      Vector x2 = new Vector(x2Array);
      Vector y2 = new Vector(y2Array);
      MultipleLinearRegression r2 = new PolynomialRegression(y2, x2, p);
      System.out.println("beta2 = " + r2.getEstimatedCoefficients());

      System.out.println("");
      double[] y3Array = new double[]{1, 2, 5, 4};
      double[] y4Array = new double[]{4, 3, 4, 5};
      double[] y5Array = new double[]{3, 4, 5, 7};
      MultipleLinearRegression r3 = new PolynomialRegression(new Vector(y3Array), x2,p);
      System.out.println("beta3 = " + r3.getEstimatedCoefficients());
      MultipleLinearRegression r4 = new PolynomialRegression(new Vector(y4Array), x2,p);
      System.out.println("beta4 = " + r4.getEstimatedCoefficients());
      MultipleLinearRegression r5 = new PolynomialRegression(new Vector(y5Array), x2,p);
