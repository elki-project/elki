...
/**
 * Wrapper class for OPTICS algorithm. Performs an attribute wise normalization on
...
public class OPTICSWrapper extends FileBasedDatabaseConnectionWrapper {
  ...
  public OPTICSWrapper() {
    super();
    parameterToDescription.put(OPTICS.EPSILON_P + OptionHandler.EXPECTS_VALUE, OPTICS.EPSILON_D);
