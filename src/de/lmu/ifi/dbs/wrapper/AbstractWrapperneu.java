 ...
 */
public abstract class AbstractWrapperneu implements Wrapper, Parameterizable {
  /**
   ...
   * </pre>
   */
  protected AbstractWrapperneu() {
    parameterToDescription.put(AbstractWrapperneu.VERBOSE_F, AbstractWrapperneu.VERBOSE_D);
    parameterToDescription.put(AbstractWrapperneu.TIME_F, AbstractWrapperneu.TIME_D);
    parameterToDescription.put(AbstractWrapperneu.INPUT_P + OptionHandler.EXPECTS_VALUE, AbstractWrapperneu.INPUT_D);
    parameterToDescription.put(AbstractWrapperneu.OUTPUT_P + OptionHandler.EXPECTS_VALUE, AbstractWrapperneu.OUTPUT_D);
  ...
  public String[] setParameters(String[] args) {
    ...
    verbose = optionHandler.isSet(AbstractWrapperneu.VERBOSE_F);
    time = optionHandler.isSet(AbstractWrapperneu.TIME_F);
    input = optionHandler.getOptionValue(AbstractWrapperneu.INPUT_P);
    output = optionHandler.getOptionValue(AbstractWrapperneu.OUTPUT_P);
