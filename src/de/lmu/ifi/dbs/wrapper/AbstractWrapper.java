...
/**
 * AbstractWrapper sets the values for flags verbose and help. <p/> Any
...
//  private static final boolean DEBUG = true;
  ...
  /**
   * Indicates wether verbose messages should be printed
   * while performing the wrapper.
   */
  private boolean verbose;

  /**
   * The remaining parameters after the option handler grabbed the options for this wrapper.
   */
  private List<String> remainingParameters;

  /**
   * Sets the parameters for the verbose and help flags in the parameter map. Any extending
