 ...
 */
public class HierarchicalCOPACWrapper extends NormalizationWrapper {
  ...
  public static void main(String[] args) {
    HierarchicalCOPACWrapper wrapper = new HierarchicalCOPACWrapper();
    try {
   ...
   */
  public HierarchicalCOPACWrapper() {
    super();
    // parameter epsilon
    PatternParameter eps = new PatternParameter(DBSCAN.EPSILON_P, HierarchicalCOPACWrapper.EPSILON_D);
    ...
    // parameter k
    IntParameter kPam = new IntParameter(KnnQueryBasedHiCOPreprocessor.K_P, HierarchicalCOPACWrapper.K_D, new GreaterConstraint(0));
  ...
  public List<String> getKDDTaskParameters() {
    ...
    parameters.add(HierarchicalCOPAC.class.getName());
