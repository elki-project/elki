...
public class HiSCWrapper extends FileBasedDatabaseConnectionWrapper
{
     ...
     */
    public static final String K_D = "<k>a positive integer specifying the number of " + "nearest neighbors considered to determine the preference vector. " + "If this value is not defined, k ist set to minpts.";
