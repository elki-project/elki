...
public class CODECWrapper extends FileBasedDatabaseConnectionWrapper
{
    ...
    {
        super();
        parameterToDescription.put(DBSCAN.EPSILON_P
                + OptionHandler.EXPECTS_VALUE, EPSILON_D);
        parameterToDescription.put(DBSCAN.MINPTS_P
                + OptionHandler.EXPECTS_VALUE, OPTICS.MINPTS_D);
        parameterToDescription.put(
                KnnQueryBasedCorrelationDimensionPreprocessor.K_P
                        + OptionHandler.EXPECTS_VALUE, K_D);
    ...
    public List<String> getParameters() throws ParameterException
    {
        ...
        parameters.add(KnnQueryBasedCorrelationDimensionPreprocessor.class
                .getName());
        ...
        parameters.add(OptionHandler.OPTION_PREFIX
                + KnnQueryBasedCorrelationDimensionPreprocessor.K_P);
        if (optionHandler
                .isSet(KnnQueryBasedCorrelationDimensionPreprocessor.K_P))
        {
            parameters
                    .add(optionHandler
                            .getOptionValue(KnnQueryBasedCorrelationDimensionPreprocessor.K_P));
        } else
        {
            parameters.add(optionHandler.getOptionValue(OPTICS.MINPTS_P));
        }
