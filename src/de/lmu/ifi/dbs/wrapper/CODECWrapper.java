...
/**
 * Wrapper class for the CoDeC algorithm. Performs an attribute wise normalization on
 * the database objects, partitions the database according to the correlation dimension of
 * its objects, performs the algorithm DBSCAN over the partitions
 * and then determines the correlation dependencies in each cluster of each partition.
 *
