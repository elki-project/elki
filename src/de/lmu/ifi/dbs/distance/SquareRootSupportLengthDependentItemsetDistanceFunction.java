...
public class SquareRootSupportLengthDependentItemsetDistanceFunction extends FrequencyDependentItemsetDistanceFunction
{
     ...
     * Distance is (sqrt(1.0 - support(%))/ (i==0 ? 1 : i)) * max{1-ratio(i,card1),1-ratio(i,card2)},
    ...
    {
        return "Distance is (sqrt(1.0 - support(%))/(i==0 ? 1 : i)) * max{1-ratio(i,o1),1-ratio(i,o2)}, where i is the number of bits shared by both BitVectors, o is the number of bits in the respective BitVector, and ratio(i,o) is 1 if o is 0, i/o otherwise.";
    }
}
