 ...
 */
public class EuklideanDistanceFunction extends DoubleDistanceFunction implements SpatialDistanceFunction {
  /**
  ...
  *      de.lmu.ifi.dbs.data.FeatureVector)
  ...
  /**
   * Set the database that holds the associations for the RealVectors
   * for which the distances should be computed. This method does
   * nothing because in this distance function no associations are needed.
   *
