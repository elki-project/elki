...
public interface DistanceFunction extends Parameterizable {
  ...
  /**
   * Returns true, if the given distance is an infinite distance,
   * false otherwise.
   *
   * @param distance the distance to be tested on infinity
   * @return true, if the given distance is an infinite distance,
   *         false otherwise
   */
  boolean isInfiniteDistance(Distance distance);

  /**
   * Returns true, if the given distance is a null distance,
   * false otherwise.
   *
   * @param distance the distance to be tested whether it is a null distance
   * @return true, if the given distance is a null distance,
   *         false otherwise
   */
  boolean isNullDistance(Distance distance);

  /**
   * Returns true, if the given distance is an undefined distance,
   * false otherwise.
   *
   * @param distance the distance to be tested whether it is undefined
   * @return true, if the given distance is an undefined distance,
   *         false otherwise
   */
  ...
  /**
   * Computes the distance between two given MetricalObjects according to this distance function.
   *
   * @param o1 first MetricalObject
   * @param o2 second MetricalObject
   * @return the distance between two given MetricalObjects according to this distance function
   */
  Distance distance(MetricalObject o1, MetricalObject o2);

  /**
   * Set the database that holds the associations for the MetricalObject
