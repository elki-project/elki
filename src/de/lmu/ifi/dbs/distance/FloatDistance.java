...
public class FloatDistance extends NumberDistance {
  /**
  ...
  /**
   * Constructs a new FloatDistance object that represents the float
   * argument.
   *
   ...
   */
  public FloatDistance plus(Distance distance) {
    FloatDistance other = (FloatDistance) distance;
    return new FloatDistance(this.value + other.value);
  }

  /**
   * @see de.lmu.ifi.dbs.distance.Distance#minus(Distance)
   */
  public FloatDistance minus(Distance distance) {
    FloatDistance other = (FloatDistance) distance;
    return new FloatDistance(this.value - other.value);
  }
  ...
  public int compareTo(Distance d) {
    FloatDistance other = (FloatDistance) d;
