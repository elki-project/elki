 ...
 */
public class SupportLengthDependentItemsetDistanceFunction extends FrequencyDependentItemsetDistanceFunction
{
     ...
     * Distance is ((1.0 - support(%))/card_i) * max{1-ratio(i,card1),1-ratio(i,card2)},
    ...
    public Distance distance(BitVector o1, BitVector o2)
    {
        ...
        return new DoubleDistance(Math.max(1 - ratio(i,card1), 1 - ratio(i,card2)) * (1.0 - support) / i);
    }
    ...
    {
        return "Distance is ((1.0 - support(%))/card_i) * max{1-ratio(i,o1),1-ratio(i,o2)}, where i is the number of bits shared by both BitVectors, o is the number of bits in the respective BitVector, and ratio(i,o) is 1 if o is 0, i/o otherwise.";
    }
}
