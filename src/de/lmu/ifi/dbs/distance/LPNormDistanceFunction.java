...
public class LPNormDistanceFunction extends DoubleDistanceFunction<FeatureVector>
{
    ...
    /**
     * Returns the distance between the specified FeatureVectors
     * as a LP-Norm for the currently set p. 
     * 
     * 
     * @param o1 first FeatureVector
     * @param o2 second FeatureVector
     * @return the distance between the specified FeatureVectors
     * as a LP-Norm for the currently set p
     */
    public Distance distance(FeatureVector o1, FeatureVector o2)
    {
    ...
    {
        return "L-Norm for FeatureVectors.";
    }
