...
public class RationalNumber extends Number implements Arithmetic<RationalNumber> {
   ...
   * @throws IllegalArgumentException if {@link BigInteger#equals(Object) denominator.equals(}{@link BigInteger#ZERO BigInteger.ZERO)}
   */
  ...
  public RationalNumber absValue() {
    if (this.compareTo(RationalNumber.ZERO) >= 0) return this;
    else return this.additiveInverse();
  }
