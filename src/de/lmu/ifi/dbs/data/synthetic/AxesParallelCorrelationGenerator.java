...
public class AxesParallelCorrelationGenerator extends StandAloneWrapper {
	...
	public static final String DEPENDENT_VALUES_D = "<p_1,...,p_d>a vector specifying "
			...
			+ "If no preference vector is specified, the " + "first dataDim - corrDim variables are the dependent variables "
	...
	public AxesParallelCorrelationGenerator() {
		...
		// parameter label
		StringParameter label = new StringParameter(LABEL_P, LABEL_D);
		label.setDefaultValue("");
		optionHandler.put(LABEL_P, label);
