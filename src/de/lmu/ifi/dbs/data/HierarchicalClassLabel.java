...
public class HierarchicalClassLabel extends ClassLabel<HierarchicalClassLabel>
{
    ...
    /**
     * Constructs a hierarchical class label from the given name,
     * using the given Pattern to match separators of different levels
     * in the given name, and setting the given separator-String
     * to separate different levels in String representations of this
     ...
     * Names at higher levels are compared first.
     * Names at a lower level are compared only if
     * their parent-names are equal.
     * Names at a level are tried to be compared
     * as integer values. If this does not succeed,
     * both names are compared as Strings.
    ...
    /**
     * Returns a String representation of this HierarchicalClassLabel
     * using {@link #separatorString separatorString} to separate levels.
     * 
    ...
    /**
     * Provides a String representation of this ClassLabel
     * comprising only the first <code>level</code> levels.
     * 
     * @param level the lowest level to include in the String representation.
     * @return a String representation of this ClassLabel
     * comprising only the first <code>level</code> levels
     */
