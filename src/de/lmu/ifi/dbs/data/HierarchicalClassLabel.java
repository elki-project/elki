...
public class HierarchicalClassLabel extends ClassLabel<HierarchicalClassLabel>
{
    ...
    // * points ('.'), as defined by {@link #DEFAULT_SEPARATOR
    // DEFAULT_SEPARATOR}.
    ...
    /**
     * Constructs a hierarchical class label from the given name, using the
    ...
    /**
     * Constructs a hierarchical class label from the given name. Different
     * levels are supposed to be separated by points ('.'), as defined by
