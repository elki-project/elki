 ...
 * DatabaseObject. The equals-method is implemented dynamically for all subclasses
 * to satisfy the requirements as defined in {@link DatabaseObject#equals(Object) DatabaseObject.equals(Object)}.
 * It needs not to be overwritten except for sake of efficiency.
 *
 * @author Arthur Zimek (<a href="mailto:zimek@dbs.ifi.lmu.de">zimek@dbs.ifi.lmu.de</a>)
 */
public abstract class NumberVector<N extends Number> extends AbstractDatabaseObject implements FeatureVector<N> {
  ...
  /**
   * An Object obj is equal to this NumberVector
   * if it is an instance of the same runtime class
   * and is of the identical dimensionality
   * and the values of this NumberVector are equal
  ...
  public boolean equals(Object obj) {
    if (this.getClass().isInstance(obj)) {
      NumberVector rv = (NumberVector) obj;
