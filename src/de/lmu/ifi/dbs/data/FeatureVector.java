 ...
 */
public interface FeatureVector<N extends Number> extends DatabaseObject<FeatureVector<N>> {
   ...
   */
  FeatureVector<N> newInstance(N[] values) throws SecurityException, NoSuchMethodException, IllegalArgumentException, InstantiationException, IllegalAccessException, InvocationTargetException;
