 ...
 */
public class KnnQueryBasedCorrelationDimensionPreprocessor extends
        CorrelationDimensionPreprocessor
{
    ...
    /**
     * @see CorrelationDimensionPreprocessor#objectIDsForPCA(Integer, Database,
     *      boolean, boolean)
     */
    protected List<Integer> objectIDsForPCA(Integer id,
            Database<RealVector> database, boolean verbose, boolean time)
    {
        if (k == UNDEFINED_K)
        {
        ...
        List<QueryResult<DoubleDistance>> knns = database.kNNQueryForID(id, k,
                pcaDistanceFunction);
