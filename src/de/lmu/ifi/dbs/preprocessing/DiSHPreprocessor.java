...
public class DiSHPreprocessor extends AbstractParameterizable implements PreferenceVectorPreprocessor<RealVector> {
  ...
  private BitSet determinePreferenceVectorByApriori(Database<RealVector> database,
                                                    ...
                                                    StringBuffer msg) throws ParameterException, UnableToComplyException {
   ...
   */
  private DimensionSelectingDistanceFunction[] initDistanceFunctions(Database<RealVector> database,
                                                                     int dimensionality,
                                                                     boolean verbose,
