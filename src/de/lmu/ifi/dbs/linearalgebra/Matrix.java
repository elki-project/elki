...
public class Matrix implements Cloneable, java.io.Serializable
{
    ...
    {
        RationalNumber[][] gauss = new RationalNumber[this.getRowDimension()][this
                .getColumnDimension()];
     ...
     *         RationalNumbers
     */
    public static RationalNumber[][] exactGaussElimination(
            RationalNumber[][] gauss)
    {
        int firstCol = -1;
        int firstRow = -1;
    ...
    public Matrix gaussElimination()
    {
        ...
        if (firstCol != -1)
        {
            ...
            {
                Matrix subMatrix = gauss.getMatrix(1,
                        gauss.getRowDimension() - 1, 0, gauss
                                .getColumnDimension() - 1);
                gauss
                        .setMatrix(1, gauss.getRowDimension() - 1, 0, gauss
                                .getColumnDimension() - 1, subMatrix
                                .gaussElimination());
            }
        }
        return gauss;
     ...
     * @throws IllegalArgumentException
     *             if this matrix is no row vector, i.e. this matrix has more
    ...
    {
        double[][] m = { { 0, 0, -2, 0, 7, 12 }, { 2, 4, -10, 6, 12, 28 },
                { 2, 4, -5, 6, -5, -1 } };
        ...
        timeformat.setMinimumIntegerDigits(time1 < time2 ? Long.toString(time2)
                .length() : Long.toString(time1).length());
        ...
        System.out.println("Nano seconds required for double computation: "
                + timeformat.format(time1));
        System.out.println("Nano seconds required for exact computation:  "
                + timeformat.format(time2));
    ...
    public boolean linearlyIndependent(Matrix a)
    {
        ...
        if (this.getColumnDimension() + a.getColumnDimension() > this
                .getRowDimension())
            return false;
        ...
        double[][] values = new double[this.getRowDimension()][this
                .getColumnDimension()
