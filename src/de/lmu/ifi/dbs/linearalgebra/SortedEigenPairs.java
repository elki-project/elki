...
/**
 * Helper class which encapsulates an eigenvector and its corresponding eigenvalue. This class is used to
...
public class SortedEigenPairs {
  ...
  /**
   * Creates a new EigenPairs object from the specified eigenvalue decomposition.
   * The eigenvectors are sorted according to the specified order.
   *
