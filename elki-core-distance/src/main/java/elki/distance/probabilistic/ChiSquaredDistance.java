...
public class ChiSquaredDistance extends AbstractNumberVectorDistance implements SpatialPrimitiveDistance<NumberVector> {
  /**
   * Static instance. Use this!
   */
  public static final ChiSquaredDistance STATIC = new ChiSquaredDistance();
