 ...
 */
@Alias({ "minimum", "min" })
public class MinimumDistance extends AbstractNumberVectorDistance implements SpatialPrimitiveDistance<NumberVector>, Norm<NumberVector> {
  /**
   * Static instance. Use this.
   */
  public static final MinimumDistance STATIC = new MinimumDistance();
