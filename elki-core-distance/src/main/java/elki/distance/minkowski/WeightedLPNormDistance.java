...
public class WeightedLPNormDistance extends LPNormDistance implements WeightedNumberVectorDistance<NumberVector> {
   ...
   */
  public WeightedLPNormDistance(double p, double[] weights) {
    super(p);
  ...
  public boolean equals(Object obj) {
    ...
    if(obj == null || !(obj instanceof WeightedLPNormDistance)) {
      return false;
    }
    WeightedLPNormDistance other = (WeightedLPNormDistance) obj;
      ...
      return p == 1. ? new WeightedManhattanDistance(weights) //
          : p == 2. ? new WeightedEuclideanDistance(weights) //
              : p == Double.POSITIVE_INFINITY ? new WeightedMaximumDistance(weights) //
                  : new WeightedLPNormDistance(p, weights);
    }
  }
}
