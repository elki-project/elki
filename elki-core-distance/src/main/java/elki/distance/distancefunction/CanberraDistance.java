...
@Alias({ "canberra" })
public class CanberraDistance implements SpatialPrimitiveDistance<NumberVector>, NumberVectorDistance<NumberVector> {
  /**
   * Static instance. Use this!
   */
  public static final CanberraDistance STATIC = new CanberraDistance();
