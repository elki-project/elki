 ...
 */
package elki.distance.distancefunction.timeseries;
...
public class EDRDistance extends DTWDistance {
  /**
   ...
   */
  public EDRDistance(double bandSize, double delta) {
    super(bandSize);
    this.delta = delta;
  }
  ...
  public boolean equals(Object obj) {
    return super.equals(obj) && this.delta == ((EDRDistance) obj).delta;
  }
