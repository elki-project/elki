...
public class BrayCurtisDistance extends AbstractNumberVectorDistance implements SpatialPrimitiveDistance<NumberVector> {
  /**
   * Static instance.
   */
  public static final BrayCurtisDistance STATIC_CONTINUOUS = new BrayCurtisDistance();
