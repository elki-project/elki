 ...
 * version of the {@link KullbackLeiblerDivergenceAsymmetricDistance}.
...
@Alias({ "j-divergence" })
public class JeffreyDivergenceDistance extends AbstractNumberVectorDistance implements SpatialPrimitiveDistance<NumberVector> {
  /**
   * Static instance. Use this!
   */
  public static final JeffreyDivergenceDistance STATIC = new JeffreyDivergenceDistance();
