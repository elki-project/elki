 ...
 */
package elki.distance.distancefunction.colorhistogram;
...
public class HistogramIntersectionDistance extends AbstractNumberVectorDistance implements SpatialPrimitiveDistance<NumberVector> {
  /**
   * Static instance
   */
  public static final HistogramIntersectionDistance STATIC = new HistogramIntersectionDistance();
   ...
   */
  @Deprecated
  public HistogramIntersectionDistance() {
    super();
  }
