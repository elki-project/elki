...
public abstract class AbstractDistanceTest {
   ...
   */
  public static void basicChecks(Distance<?> dist) {
   ...
   * @param <V> vector type
   */
  public static <V> void assertSameDistance(PrimitiveDistance<? super V> ref, PrimitiveDistance<? super V> test, V v1, V v2, double tol) {
   ...
   * @param tol Tolerance
   */
  public static void assertSameMinDist(SpatialPrimitiveDistance<?> ref, SpatialPrimitiveDistance<?> test, SpatialComparable v1, SpatialComparable v2, double tol) {
