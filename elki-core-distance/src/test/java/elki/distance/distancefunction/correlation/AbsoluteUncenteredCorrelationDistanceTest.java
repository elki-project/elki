 ...
 * @since 0.7.0
 */
public class AbsoluteUncenteredCorrelationDistanceTest extends AbstractDistanceTest {
  /** Inherited test data */
  final static DoubleVector[] TESTS = UncenteredCorrelationDistanceTest.TESTS;

  /** Note, these are not yet adjusted */
  final static double[][] SCORES = UncenteredCorrelationDistanceTest.SCORES;

  @Test
  public void testAbsoluteUncenteredCorrelation() {
    AbsoluteUncenteredCorrelationDistance f = AbsoluteUncenteredCorrelationDistance.STATIC;
    basicChecks(f);
