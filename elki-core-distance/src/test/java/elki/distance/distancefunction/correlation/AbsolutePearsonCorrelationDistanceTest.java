 ...
 * @since 0.7.0
 */
public class AbsolutePearsonCorrelationDistanceTest extends AbstractDistanceTest {
  /** Test set */
  ...
  public void testAbsolutePearson() {
    AbsolutePearsonCorrelationDistance f = AbsolutePearsonCorrelationDistance.STATIC;
    basicChecks(f);
