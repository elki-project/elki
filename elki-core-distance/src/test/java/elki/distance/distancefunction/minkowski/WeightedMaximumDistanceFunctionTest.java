...
import elki.distance.distancefunction.WeightedNumberVectorDistanceFunction;
 ...
 * @since 0.7.5
 */
public class WeightedMaximumDistanceFunctionTest extends AbstractDistanceFunctionTest {
  @Test
  public void testSpatialConsistency() {
    // Also test the builder
    WeightedMaximumDistanceFunction dist = new ELKIBuilder<>(WeightedMaximumDistanceFunction.class) //
