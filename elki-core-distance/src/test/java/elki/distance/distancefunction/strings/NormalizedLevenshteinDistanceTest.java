 ...
 */
package elki.distance.distancefunction.strings;
 ...
 * @since 0.7.0
 */
public class NormalizedLevenshteinDistanceTest extends AbstractDistanceTest {
  /**
  ...
  public void testStringLevenshtein() {
    NormalizedLevenshteinDistance f = NormalizedLevenshteinDistance.STATIC_SENSITIVE;
    basicChecks(f);
