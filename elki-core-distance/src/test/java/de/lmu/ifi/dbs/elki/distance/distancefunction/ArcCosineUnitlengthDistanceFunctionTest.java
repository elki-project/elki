 ...
 */
public class ArcCosineUnitlengthDistanceFunctionTest extends AbstractSpatialPrimitiveDistanceFunctionTest {
  @Test
  public void testSpatialConsistency() {
    // Also test the builder - we could have just used .STATIC
    ArcCosineUnitlengthDistanceFunction dis = new ELKIBuilder<>(ArcCosineUnitlengthDistanceFunction.class).build();
  ...
  public void compareOnUnitSphere() {
    ...
    ArcCosineUnitlengthDistanceFunction cosnorm = ArcCosineUnitlengthDistanceFunction.STATIC;
    ArcCosineDistanceFunction cosfull = ArcCosineDistanceFunction.STATIC;
    for(int i = 0; i < data.length; i++) {
      for(int j = 0; j < data.length; j++) {
        ...
        assertEquals("Distances do not agree.", expected, actual, 1e-7);
  ...
  public void testNotArcCosine() {
    ...
    ArcCosineUnitlengthDistanceFunction cosnorm = new ELKIBuilder<>(ArcCosineUnitlengthDistanceFunction.class).build();
    ArcCosineDistanceFunction cosfull = new ELKIBuilder<>(ArcCosineDistanceFunction.class).build();
