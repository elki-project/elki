 ...
 */
public class ArcCosineUnitlengthDistanceFunctionTest {
  @Test
  ...
  public void testNotArcCosine() {
    ...
    assertEquals("ArcCosine not ok", 0, ArcCosineDistanceFunction.STATIC.distance(d1, d2), 0);
    assertEquals("Length not ignored", 1.04719, ArcCosineUnitlengthDistanceFunction.STATIC.distance(d1, d2), 1e-5);
  }
}
