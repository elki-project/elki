 ...
 */
package elki.distance.distancefunction.adapter;
...
public class ArccosSimilarityAdapter<O> extends AbstractSimilarityAdapter<O> {
   ...
   */
  public ArccosSimilarityAdapter(NormalizedSimilarity<? super O> similarityFunction) {
  ...
  public static class Instance<O> extends AbstractSimilarityAdapter.Instance<O> {
     ...
     */
    public Instance(Relation<O> database, Distance<? super O> parent, SimilarityQuery<O> similarityQuery) {
