 ...
 * @since 0.7.5
 */
public class LaplaceCorrectedConfidenceTest extends AbstractFrequentItemsetAlgorithmTest {
  @Test
  public void testToyExample() {
    ...
    AssociationRuleResult res = new ELKIBuilder<>(AssociationRuleGeneration.class) //
        ...
        .with(AssociationRuleGeneration.Parameterizer.INTERESTMEASURE_ID, LaplaceCorrectedConfidence.class) //
        .build().run(db);
