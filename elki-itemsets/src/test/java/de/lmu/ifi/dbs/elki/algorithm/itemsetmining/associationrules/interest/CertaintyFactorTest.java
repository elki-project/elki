...
/**
 * Unit test for the Certainty Factor metric.
 * 
 * @author Erich Schubert
 */
public class CertaintyFactorTest extends AbstractFrequentItemsetAlgorithmTest {
  @Test
  public void testToyExample() {
    Database db = loadTransactions(UNITTEST + "itemsets/increasing5.txt", 5);
    {
      ...
      params.addParameter(AssociationRuleGeneration.Parameterizer.INTERESTMEASURE_ID, CertaintyFactor.class);
