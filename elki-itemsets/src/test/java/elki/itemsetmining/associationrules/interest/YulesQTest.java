...
/**
 * Unit test for the Yule's Q metric.
 * 
 * @author Abhishek Sharma
 * @since 0.7.5
 */
public class YulesQTest extends AbstractFrequentItemsetAlgorithmTest {
  @Test
  public void testToyExample() {
    ...
    AssociationRuleResult res = new ELKIBuilder<>(AssociationRuleGeneration.class) //
        ...
        .with(AssociationRuleGeneration.Parameterizer.INTERESTMEASURE_ID, YulesQ.class) //
        .build().run(db);
