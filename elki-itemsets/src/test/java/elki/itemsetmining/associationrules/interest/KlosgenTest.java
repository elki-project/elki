 ...
 * @since 0.7.5
 */
public class KlosgenTest extends AbstractSimpleAlgorithmTest {
  @Test
  public void testToyExample() {
    ...
    AssociationRuleResult res = new ELKIBuilder<>(AssociationRuleGeneration.class) //
        ...
        .with(AssociationRuleGeneration.Par.MINMEASURE_ID, 0.26) //
        .with(AssociationRuleGeneration.Par.INTERESTMEASURE_ID, Klosgen.class) //
        .build().autorun(db);
