 ...
 * {@link elki.index.tree.metrical.mtreevariants.mktrees.AbstractMkTreeUnified}.
...
public class MkTreeHeader extends TreeIndexHeader {
     ...
     * Calls {@link elki.index.tree.TreeIndexHeader#readHeader(java.io.RandomAccessFile)
     ...
     * Calls {@link elki.index.tree.TreeIndexHeader#writeHeader(java.io.RandomAccessFile)}
    ...
    /**
     * Returns {@link elki.index.tree.TreeIndexHeader#size()}
