 ...
 * @since 0.8.0
 */
public class NaiveAgglomerativeHierarchicalClustering1Test extends AbstractClusterAlgorithmTest {
  @Test
  public void testSingleLink() {
    Database db = makeSimpleDatabase(UNITTEST + "single-link-effect.ascii", 638);
    Clustering<?> clustering = new ELKIBuilder<NaiveAgglomerativeHierarchicalClustering1<?>>(NaiveAgglomerativeHierarchicalClustering1.class) //
