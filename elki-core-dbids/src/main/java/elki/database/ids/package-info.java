 ...
 * <th style="border-bottom: 2px">{@link elki.database.ids.HashSetDBIDs HashSetDBIDs}</th>
 * </tr>
 * <tr>
 * <th style="border-right: 2px">{@link elki.database.ids.ModifiableDBIDs ModifiableDBIDs}</th>
 * <td>{@link elki.database.ids.ArrayModifiableDBIDs ArrayModifiableDBIDs}</td>
 * <td>{@link elki.database.ids.HashSetModifiableDBIDs HashSetModifiableDBIDs}</td>
 * </tr>
 * <tr>
 * <th style="border-right: 2px">{@link elki.database.ids.StaticDBIDs StaticDBIDs}</th>
 * <td>{@link elki.database.ids.ArrayStaticDBIDs ArrayStaticDBIDs}</td>
 * <td>n/a</td>
 * </tr>
 * </table>
 * <p>
 ...
 * <li>{@link elki.database.ids.DBIDUtil#ensureModifiable DBIDUtil.ensureModifiable} to ensure {@link elki.database.ids.ModifiableDBIDs ModifiableDBIDS}</li>
 * <li>{@link elki.database.ids.DBIDUtil#makeUnmodifiable DBIDUtil.makeUnmodifiable} to wrap DBIDs unmodifiable</li>
 * </ul>
 *
