...
dfs = [
	...
	("loggamma", "1_1", scipy.stats.loggamma(1, scale=1./1), None, 83),
	("loggamma", "2_1", scipy.stats.loggamma(2, scale=1./1), None, 84),
	("loggamma", "4_1", scipy.stats.loggamma(4, scale=1./1), None, 85),
	("loggamma", "4_10", scipy.stats.loggamma(4, scale=1./10), None, 86),
	("loggamma", "01_10", scipy.stats.loggamma(.1, scale=1./10), None, 87),
	("loggamma", "01_20", scipy.stats.loggamma(.1, scale=1./20), None, 88),
	("loggamma", "01_4", scipy.stats.loggamma(.1, scale=1./4), None, 89),
	("loggamma", "01_1", scipy.stats.loggamma(.1, scale=1./1), None, 90),
