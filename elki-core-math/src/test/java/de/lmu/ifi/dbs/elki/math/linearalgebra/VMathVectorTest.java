...
/**
 * Class testing the methods of the {@link VMath} class, which provide mathematical operations and have 
...
public final class VMathVectorTest {
  ...
  public void testPlus() {
    ...
    assertArrayEquals(res_plus_I, plus(v1_I,v2_I), EPSILON);
    assertArrayEquals(res_plus_I, plusEquals(copy(v1_I), v2_I), EPSILON);
  ...
  /**
   * Testing the timesTranspose(vector, vector) method of VMath class. 
   */
  @Test
  ...
  /**
   * Testing the normalize(Vector) and normalizeEquals(Vector) methods of the VMath class.
   * 
   * 
   */
  @Test
  public void testNormalize() {
    ...
    // That more methods ensure the result we use squareSum instead of euclideanLength here
  ...
  /**
   * Testing the summation methods and the euclidienLength method of VMath class.
   */
  @Test
