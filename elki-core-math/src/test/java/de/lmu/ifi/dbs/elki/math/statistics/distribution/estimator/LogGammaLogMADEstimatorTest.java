...
/**
 * Regression test the estimation for the LogGammaLogMAD distribution.
 * 
 * @author Erich Schubert
 */
public class LogGammaLogMADEstimatorTest extends AbstractDistributionEstimatorTest {
  @Test
  public void testEstimator() {
    final LogGammaLogMADEstimator est = LogGammaLogMADEstimator.STATIC;
