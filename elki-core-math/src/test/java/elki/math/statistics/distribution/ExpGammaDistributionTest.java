...
public class ExpGammaDistributionTest extends AbstractDistributionTest {
  ...
  public void testPDF() {
    ...
    assertPDF(new ExpGammaDistribution(4., 10, 0.), "pdf_scipy_4_10", 2e-14);
    assertPDF(new ExpGammaDistribution(.1, 10, 0.), "pdf_scipy_01_10", 2e-14);
    assertPDF(new ExpGammaDistribution(.1, 20, 0.), "pdf_scipy_01_20", 2e-14);
    assertPDF(new ExpGammaDistribution(.1, 4., 0.), "pdf_scipy_01_4", 2e-14);
