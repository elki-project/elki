...
/**
 * Unit test for the {@link LeastSSQSplit}.
 *
 * @author Erich Schubert
 * @since 0.8.0
 */
public class LeastSSQSplitTest extends AbstractIndexStructureTest {
  @Test
  public void testMemoryKDTree() {
    MemoryKDTree.Factory<?> factory = new ELKIBuilder<>(MemoryKDTree.Factory.class) //
        .with(MemoryKDTree.Factory.Par.SPLIT_P, LeastSSQSplit.class) //
