...
/**
 * Unit test for the {@link MedianVarianceSplit}.
 *
 * @author Erich Schubert
 * @since 0.8.0
 */
public class MedianVarianceSplitTest extends AbstractIndexStructureTest {
  @Test
  public void testMemoryKDTree() {
    MemoryKDTree.Factory<?> factory = new ELKIBuilder<>(MemoryKDTree.Factory.class) //
        .with(MemoryKDTree.Factory.Par.SPLIT_P, MedianVarianceSplit.class) //
