...
import elki.index.tree.spatial.kd.MemoryKDTree;
import elki.utilities.ELKIBuilder;

/**
 * Unit test for the {@link BoundedMidpointSplit}.
 *
 * @author Erich Schubert
 * @since 0.8.0
 */
public class BoundedMidpointSplitTest extends AbstractIndexStructureTest {
  @Test
  public void testMemoryKDTree() {
    MemoryKDTree.Factory<?> factory = new ELKIBuilder<>(MemoryKDTree.Factory.class) //
        .with(MemoryKDTree.Factory.Par.SPLIT_P, BoundedMidpointSplit.class) //
