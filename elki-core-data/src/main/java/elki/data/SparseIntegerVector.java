...
public class SparseIntegerVector implements SparseNumberVector {
   ...
   */
  private static final int INT0 = Integer.valueOf(0);
  ...
  public String toString() {
    StringBuilder featureLine = new StringBuilder(14 * this.indexes.length)//
  ...
  public static class Factory implements SparseNumberVector.Factory<SparseIntegerVector> {
    ...
    public static class Par implements Parameterizer {
      @Override
      public SparseIntegerVector.Factory make() {
        return FACTORY;
      }
    }
  }
   ...
   * @author Erich Schubert
   *
   * @assoc - serializes - SparseIntegerVector
   */
