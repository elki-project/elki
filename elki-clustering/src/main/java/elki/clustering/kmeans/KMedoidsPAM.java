...
import elki.clustering.kmeans.initialization.PAMInitialMeans;
...
public class KMedoidsPAM<V> extends AbstractDistanceBasedAlgorithm<Distance<? super V>, Clustering<MedoidModel>> implements ClusteringAlgorithm<Clustering<MedoidModel>> {
  /**
   ...
   */
  public KMedoidsPAM(Distance<? super V> distanceFunction, int k, int maxiter, KMedoidsInitialization<V> initializer) {
