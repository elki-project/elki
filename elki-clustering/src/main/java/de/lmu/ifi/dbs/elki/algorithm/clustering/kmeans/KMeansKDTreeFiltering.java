 ...
 * Alsabti et al., see {@link KMeansKDTreePruning}.
 * <p>
 * References:
 * <p>
...
public class KMeansKDTreeFiltering<V extends NumberVector> extends KMeansKDTreePruning<V> {
  /**
   * The logger for this class.
   */
  private static final Logging LOG = Logging.getLogger(KMeansKDTreeFiltering.class);
   ...
   */
  protected class Instance extends KMeansKDTreePruning<V>.Instance {
    /**
     * Constructor.
     *
   ...
   * @author Erich Schubert
   */
  public static class Parameterizer<V extends NumberVector> extends KMeansKDTreePruning.Parameterizer<V> {
    @Override
    protected KMeansKDTreeFiltering<V> makeInstance() {
      return new KMeansKDTreeFiltering<>(distanceFunction, k, maxiter, initializer, split, leafsize);
    }
  }
}
