...
/**
 * Test FasterMSC clustering.
 *
 * @author Erich Schubert
 * @since 0.8.0
 */
public class FasterMSCTest extends AbstractClusterAlgorithmTest {
  @Test
  public void testFasterMSC() {
  ...
  @Test
  public void testFasterMSCworseStart() {
    Database db = makeSimpleDatabase(UNITTEST + "3clusters-and-noise-2d.csv", 330);
    Clustering<MedoidModel> result = new ELKIBuilder<FasterMSC<NumberVector>>(FasterMSC.class) //
