 ...
 * @author Andreas Lang
 */
public class BIRCHEMnaiveTest extends AbstractClusterAlgorithmTest {
  @Test
  public void testSpherical() {
    ...
    Clustering<?> clustering = new ELKIBuilder<>(BIRCHEMnaive.class) //
        ...
        .with(BIRCHEMnaive.Par.INIT_ID, EMSphericalInitializer.class)//
  ...
  public void testDiagonal() {
    ...
    Clustering<?> clustering = new ELKIBuilder<>(BIRCHEMnaive.class) //
        ...
        .with(AbstractKMeans.K_ID, 4) //
        .with(BIRCHEMnaive.Par.DELTA_ID, 1e-7)//
        .with(BIRCHEMnaive.Par.INIT_ID, EMDiagonalInitializer.class)//
        .with(AbstractEMInitializer.Par.INIT_ID, CFKMeansPlusPlus.class)//
        .with(AbstractCFKMeansInitialization.Par.SEED_ID, 0) //
        .build().autorun(db);
  ...
  public void testMultivariate() {
    ...
    Clustering<?> clustering = new ELKIBuilder<>(BIRCHEMnaive.class) //
        ...
        .with(AbstractKMeans.K_ID, 4) //
        .with(BIRCHEMnaive.Par.DELTA_ID, 1e-7)//
        .with(BIRCHEMnaive.Par.INIT_ID, EMMultivariateInitializer.class)//
        .with(AbstractEMInitializer.Par.INIT_ID, CFKMeansPlusPlus.class)//
        .with(AbstractCFKMeansInitialization.Par.SEED_ID, 0) //
        .build().autorun(db);
