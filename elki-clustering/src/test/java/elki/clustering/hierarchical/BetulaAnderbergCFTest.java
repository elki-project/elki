 ...
 * @author Andreas Lang
 */
public class BetulaAnderbergCFTest extends AbstractClusterAlgorithmTest {
  ...
  public void testWard() {
    ...
    Clustering<?> clustering = new ELKIBuilder<>(CutDendrogramByNumberOfClusters.class) //
        ...
        .with(Algorithm.Utils.ALGORITHM_ID, BetulaAnderbergCF.class) //
        .with(DISTANCE_ID, VarianceIncreaseDistance.class) // s
  ...
  public void testWardA() {
    ...
    Clustering<?> clustering = new ELKIBuilder<>(CutDendrogramByNumberOfClusters.class) //
        ...
        .with(Algorithm.Utils.DISTANCE_FUNCTION_ID, VarianceIncreaseDistance.class) //
        .build().autorun(db);
    assertFMeasure(db, clustering, 0.94024306);
