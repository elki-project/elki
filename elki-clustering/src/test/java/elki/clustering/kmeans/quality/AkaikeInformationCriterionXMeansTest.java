 ...
 * @since 0.7.5
 */
public class AkaikeInformationCriterionXMeansTest extends AbstractClusterAlgorithmTest {
  @Test
  public void testXMeans() {
    ...
    Clustering<?> result = new ELKIBuilder<XMeans<DoubleVector, ?>>(XMeans.class) //
        ...
        .with(KMeans.K_ID, 20) //
        .with(XMeans.Parameterizer.INFORMATION_CRITERION_ID, AkaikeInformationCriterionXMeans.class) //
