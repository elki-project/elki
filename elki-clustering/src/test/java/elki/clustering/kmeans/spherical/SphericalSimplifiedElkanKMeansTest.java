 ...
 */
public class SphericalSimplifiedElkanKMeansTest extends AbstractClusterAlgorithmTest {
  @Test
  public void testSphericalSimplifiedElkanKMeans() {
    ...
    Clustering<?> result = new ELKIBuilder<SphericalSimplifiedElkanKMeans<DoubleVector>>(SphericalSimplifiedElkanKMeans.class) //
        .with(KMeans.K_ID, 5) //
