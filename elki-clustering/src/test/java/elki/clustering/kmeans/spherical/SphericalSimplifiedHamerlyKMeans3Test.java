 ...
 */
public class SphericalSimplifiedHamerlyKMeans3Test extends AbstractClusterAlgorithmTest {
  @Test
  public void testSphericalSimplifiedHamerlyKMeans3() {
    ...
    Clustering<?> result = new ELKIBuilder<SphericalSimplifiedHamerlyKMeans3<DoubleVector>>(SphericalSimplifiedHamerlyKMeans3.class) //
        .with(KMeans.K_ID, 5) //
