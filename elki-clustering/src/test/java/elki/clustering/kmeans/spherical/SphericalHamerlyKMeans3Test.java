 ...
 */
public class SphericalHamerlyKMeans3Test extends AbstractClusterAlgorithmTest {
  @Test
  public void testSphericalHamerlyKMeans2() {
    ...
    Clustering<?> result = new ELKIBuilder<SphericalHamerlyKMeans3<DoubleVector>>(SphericalHamerlyKMeans3.class) //
        .with(KMeans.K_ID, 5) //
