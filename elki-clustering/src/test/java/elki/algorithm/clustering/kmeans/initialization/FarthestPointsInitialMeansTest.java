 ...
 */
package elki.algorithm.clustering.kmeans.initialization;

import org.junit.Test;

import elki.algorithm.clustering.AbstractClusterAlgorithmTest;
import elki.algorithm.clustering.kmeans.CLARA;
import elki.algorithm.clustering.kmeans.KMeans;
import elki.algorithm.clustering.kmeans.SingleAssignmentKMeans;
 ...
 * @since 0.7.5
 */
public class FarthestPointsInitialMeansTest extends AbstractClusterAlgorithmTest {
  /**
  ...
  public void testFarthestPointsInitialMeans() {
    ...
    Clustering<?> result = new ELKIBuilder<SingleAssignmentKMeans<DoubleVector>>(SingleAssignmentKMeans.class) //
        ...
        .with(KMeans.INIT_ID, FarthestPointsInitialMeans.class) //
        .build().run(db);
