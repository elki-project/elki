...
/**
 * 
 * Test Class for testing {@link EvaluateDBCV} with ByLable clustering
 * 
 * note:
 * This measurement is unpredictable, adding a second test changed the result.
 * Although this might be an error, it is to say that the calculation of the MSP
 * is not unambiguous.
 * 
 * @author Robert Gehde
 *
 */
public class EvalDBCVTest {
  // the following values depend on the data set used!
  final static String dataset = "elki/testdata/unittests/uebungsblatt-2d-mini-jitter.csv";

  /**
   * Test for {@link EvaluateDBCV} with ByLable clustering
   */
  @Test
