...
/**
 * Test Class for testing {@link EvaluateSilhouette} with ByLable and KMeans
 * clustering
 * 
 * @author Robert Gehde
 *
 */
public class EvalSilhouetteTest {

  final static String dataset = "elki/testdata/unittests/uebungsblatt-2d-mini.csv";

  /**
   * Test for {@link EvaluateSilhouette} with ByLable clustering and
  ...
  /**
   * Test for {@link EvaluateSilhouette} with ByLable clustering and MERGE_NOISE
   * option
   */
  @Test
