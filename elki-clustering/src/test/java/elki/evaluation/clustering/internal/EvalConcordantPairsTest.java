...
/**
 * 
 * Test Class for testing {@link EvaluateConcordantPairs} with ByLable
 * and KMeans Clustering
 * 
 * @author Robert Gehde
 *
 */
public class EvalConcordantPairsTest {
  // the following values depend on the data set used!
  final static String dataset = "elki/testdata/unittests/uebungsblatt-2d-mini.csv";

  /**
   * Regression test for {@link EvaluateConcordantPairs} with ByLable clustering
   */
  @Test
