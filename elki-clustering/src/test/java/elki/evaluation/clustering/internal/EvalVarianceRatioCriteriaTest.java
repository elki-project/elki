...
/**
 * Test Class for testing {@link EvaluateVarianceRatioCriteria} with ByLable and
 * KMeans clustering
 * 
 * @author Robert Gehde
 *
 */
public class EvalVarianceRatioCriteriaTest {

  final static String dataset = "elki/testdata/unittests/uebungsblatt-2d-mini.csv";

  /**
   * Test for {@link EvaluateVarianceRatioCriteria} with ByLable clustering and
