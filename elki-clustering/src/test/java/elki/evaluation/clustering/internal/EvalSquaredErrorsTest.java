...
/**
 * Class for testing {@link EvaluateSquaredErrors} Measures with ByLable and
 * KMeans clustering
 * 
 * @author Robert Gehde
 *
 */
public class EvalSquaredErrorsTest {

  final static String dataset = "elki/testdata/unittests/uebungsblatt-2d-mini.csv";

  /**
   * Test for {@link EvaluateSquaredErrors} Measures with ByLable clustering and
