...
/**
 * 
 * Test Class for testing {@link EvaluateDaviesBouldin} with ByLable and KMeans
 * clustering
 * 
 * @author Robert Gehde
 *
 */
public class EvalDaviesBouldinTest {
  // the following values depend on the data set used!
  final static String dataset = "elki/testdata/unittests/uebungsblatt-2d-mini.csv";

  /**
   * Test for {@link EvaluateDaviesBouldin} with ByLable clustering
   */
  @Test
