...
/**
 * 
 * Test Class for testing {@link EvaluatePBMIndex} with ByLable clustering
 * 
 * @author Robert Gehde
 *
 */
public class EvalPBMIndexTest {
  // the following values depend on the data set used!
  final static String dataset = "elki/testdata/unittests/uebungsblatt-2d-mini.csv";

  /**
   * Test for {@link EvaluatePBMIndex} with ByLable and KMeans clustering and
  ...
  /**
   * Regression test for {@link EvaluatePBMIndex} with ByLable clustering and
   * MERGE_NOISE option
   */
  @Test
