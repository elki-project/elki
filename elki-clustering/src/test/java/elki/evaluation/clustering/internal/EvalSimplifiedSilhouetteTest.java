...
/**
 * Test Class for testing {@link EvaluateSimplifiedSilhouette} with ByLable and
 * KMeans clustering
 * 
 * @author Robert Gehde
 *
 */
public class EvalSimplifiedSilhouetteTest {

  final static String dataset = "elki/testdata/unittests/uebungsblatt-2d-mini.csv";

  /**
   * Test for {@link EvaluateSimplifiedSilhouette} with ByLable clustering and
