 ...
 * @since 0.7.5
 */
public class KMeansBatchedLloydTest extends AbstractClusterAlgorithmTest {
  /**
  ...
  public void testKMeansBatchedLloyd() {
    ...
    Clustering<?> result = new ELKIBuilder<KMeansBatchedLloyd<DoubleVector>>(KMeansBatchedLloyd.class) //
        .with(KMeans.K_ID, 5) //
