 ...
 * @since 0.7.5
 */
public class KMeansHybridLloydMacQueenTest extends AbstractClusterAlgorithmTest {
  /**
  ...
  public void testKMeansHybridLloydMacQueen() {
    ...
    Clustering<?> result = new ELKIBuilder<KMeansHybridLloydMacQueen<DoubleVector>>(KMeansHybridLloydMacQueen.class) //
        .with(KMeans.K_ID, 5) //
