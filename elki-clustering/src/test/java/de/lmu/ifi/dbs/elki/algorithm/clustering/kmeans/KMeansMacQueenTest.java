 ...
 * @since 0.4.0
 */
public class KMeansMacQueenTest extends AbstractClusterAlgorithmTest {
  /**
  ...
  public void testKMeansMacQueen() {
    ...
    KMeansMacQueen<DoubleVector> kmeans = new ELKIBuilder<KMeansMacQueen<DoubleVector>>(KMeansMacQueen.class) //
        .with(KMeans.K_ID, 5) //
