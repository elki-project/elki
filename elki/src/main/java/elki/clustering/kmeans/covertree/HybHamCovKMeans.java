...
public class HybHamCovKMeans<V extends NumberVector> extends CoverTreeKMeans<V> {
  ...
  /**
   * stores iteration of the strategy switch
   */
  int switchover;
  ...
  protected static class Instance extends CoverTreeKMeans.Instance {
    ...
    /**
     * K-means iteration on the tree with assignment of bounds for Hamerly's
     * algorithm
     * 
    ...
    protected int assignToClusterBounds() {
      ...
      return assignNodeBounds(tree.getRoot(), k, -1, Double.POSITIVE_INFINITY, new double[k], MathUtil.sequence(0, k));
    }
    ...
    /**
     * Use of the hybrid strategy for all elements
     * 
     * @return Number of reassigned points
     */
