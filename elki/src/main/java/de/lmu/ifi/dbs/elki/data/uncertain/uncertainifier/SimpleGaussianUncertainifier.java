 ...
 */
public class SimpleGaussianUncertainifier extends AbstractUncertainifier<SimpleGaussianContinuousUncertainObject> {
  /**
   ...
   */
  public SimpleGaussianUncertainifier(double minDev, double maxDev, boolean symmetric, RandomFactory rand) {
    super();
    this.minDev = minDev;
    this.maxDev = maxDev;
   ...
   * @author Erich Schubert
   */
  public static class Parameterizer extends AbstractUncertainifier.Parameterizer {
    /**
    ...
    protected SimpleGaussianUncertainifier makeInstance() {
      return new SimpleGaussianUncertainifier(minDev, maxDev, symmetric, rand);
    }
  }
}