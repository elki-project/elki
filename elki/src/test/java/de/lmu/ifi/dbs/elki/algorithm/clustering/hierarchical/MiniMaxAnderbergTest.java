 ...
 * @since 0.6.0
 */
public class MiniMaxAnderbergTest extends AbstractSimpleAlgorithmTest {
  ...
  public void testMiniMax() {
    ...
    params.addParameter(AlgorithmStep.Parameterizer.ALGORITHM_ID, MiniMaxAnderberg.class);
