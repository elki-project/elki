 ...
 */
public class CoverTreeKMeansTest extends AbstractClusterAlgorithmTest {
  @Test
  public void testCoverTreeKMeans() {
    Database db = makeSimpleDatabase(UNITTEST + "different-densities-2d-no-noise.ascii", 1000);
    Clustering<?> result = new ELKIBuilder<>(CoverTreeKMeans.class) //
        .with(KMeans.K_ID, 5) //
