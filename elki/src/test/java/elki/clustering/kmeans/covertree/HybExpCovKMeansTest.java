 ...
 */
public class HybExpCovKMeansTest extends AbstractClusterAlgorithmTest {
  @Test
  public void testKMeansExponionCoverTree() {
    Database db = makeSimpleDatabase(UNITTEST + "different-densities-2d-no-noise.ascii", 1000);
    Clustering<?> result = new ELKIBuilder<>(HybExpCovKMeans.class) //
        .with(KMeans.K_ID, 5) //
